...
public partial class MS_ASAIRSAdapter : ManagedAdapterBase, IMS_ASAIRSAdapter
{
    ...
    private void VerifySearchResponse(SearchResponse response, DataStructures.SearchStore store)
    {
        if (Common.IsRequirementEnabled(415, Site))
        {
        ...
        VerifyCommonReqirements<Response.Search>(response);

        foreach (var search in store.Results)
        {
            VerifyCommonElementsInResponse(search.Email);
            VerifyCommonElementsInResponse(search.Calendar);
        }
    }
    #endregion
    ...
    {
        if (Common.IsRequirementEnabled(418, Site))
        {
            // Add the debug information
        ...
        var applicationDataElements = doc.SelectNodes("//*[name()='ApplicationData']");
        ...
        if (syncStore != null)
        {
            if (syncStore.AddElements != null)
            {
                foreach (var item in syncStore.AddElements)
                {
                    ...
                    {
                        var expecedValues = new string[] { "1", "2", "3" };
                        Common.VerifyActualValues("NativeBodyType", expecedValues, item.Email.NativeBodyType.ToString(), Site);
                        ...
                        VerifyUnsignedByteDataType(item.Email.NativeBodyType);
                    ...
                    VerifyCommonElementsInResponse(item.Email);
                    VerifyCommonElementsInResponse(item.Calendar);
                }
            }
        }

        VerifyCommonReqirements<Response.Sync>(response);
    }
    #endregion
    ...
    {
        if (Common.IsRequirementEnabled(344, Site))
        {
            // Add the debug information
        ...
        VerifyCommonReqirements<Response.ItemOperations>(response);

        foreach (var itemOperation in itemOperationsStore.Items)
        {
            if (itemOperation.Email != null)
            {
                VerifyCommonElementsInResponse(itemOperation.Email);
            }
                
            if (itemOperation.Calendar != null)
            {
                VerifyCommonElementsInResponse(itemOperation.Calendar);
            }
        }
    }
    #endregion
    ...
    private void VerifyCommonReqirements<T>(ActiveSyncResponseBase<T> response)
    {
        ...
        if (Common.IsRequirementEnabled(412, Site))
        {
            // Add the debug information
        ...
        if (Common.IsRequirementEnabled(413, Site))
        {
            // Add the debug information
        ...
        var bodyElementNodes = doc.SelectNodes("//*[name()='Body']");
        foreach (XmlNode bodyElementNode in bodyElementNodes)
        {
            var isDataValid = bodyElementNode.SelectNodes("*[name()='Data']").Count <= 1;
            ...
            var isEstimatedDataSizeValid = bodyElementNode.SelectNodes("*[name()='EstimatedDataSize']").Count <= 1;
            ...
            if (!Common.GetConfigurationPropertyValue("ActiveSyncProtocolVersion", Site).Equals("12.1"))
            {
                var isPreviewElementValid = bodyElementNode.SelectNodes("*[name()='Preview']").Count <= 1;
            ...
            var isTruncatedElementValid = bodyElementNode.SelectNodes("*[name()='Truncated']").Count <= 1;
            ...
            var isTypeElementValid = bodyElementNode.SelectNodes("*[name()='Type']").Count <= 1;
            ...
            && !Common.GetConfigurationPropertyValue("ActiveSyncProtocolVersion", Site).Equals("14.0"))
        {
            ...
            var bodyPartElementNodes = doc.SelectNodes("//*[name()='BodyPart']");
            foreach (XmlNode bodyPartElementNode in bodyPartElementNodes)
            {
                var isStatusValid = bodyPartElementNode.SelectNodes("*[name()='Status']").Count == 1;
                ...
                var isDataValid = bodyPartElementNode.SelectNodes("*[name()='Data']").Count <= 1;
                ...
                var isEstimatedDataSizeValid = bodyPartElementNode.SelectNodes("*[name()='EstimatedDataSize']").Count <= 1;
                ...
                var isPreviewElementValid = bodyPartElementNode.SelectNodes("*[name()='Preview']").Count <= 1;
                ...
                var isTruncatedElementValid = bodyPartElementNode.SelectNodes("*[name()='Truncated']").Count <= 1;
                ...
                var isTypeElementValid = bodyPartElementNode.SelectNodes("*[name()='Type']").Count <= 1;
        ...
        var attachmentElementNodes = doc.SelectNodes("//*[name()='Attachment']");
        foreach (XmlNode attachmentElementNode in attachmentElementNodes)
        {
            var isContentIdValid = attachmentElementNode.SelectNodes("*[name()='ContentId']").Count <= 1;
            ...
            var isContentLocationValid = attachmentElementNode.SelectNodes("*[name()='ContentLocation']").Count <= 1;
            ...
            var isDisplayNamenValid = attachmentElementNode.SelectNodes("*[name()='DisplayName']").Count <= 1;
            ...
            var isEstimatedDataSizeValid = attachmentElementNode.SelectNodes("*[name()='EstimatedDataSize']").Count <= 1;
            ...
            var isIsInLineValid = attachmentElementNode.SelectNodes("*[name()='IsInLine']").Count <= 1;
            ...
            var isMethodValid = attachmentElementNode.SelectNodes("*[name()='Method']").Count <= 1;
    ...
    private void VerifyCommonElementsInResponse(DataStructures.Email email)
    {
        if (email.Body != null)
        {
            ...
            if (email.Body.TruncatedSpecified)
            {
                ...
                VerifyBooleanDataType(email.Body.Truncated);
            }
            ...
            VerifyUnsignedByteDataType(email.Body.Type);

            var expecedValues = new string[] { "1", "2", "3", "4" };
            Common.VerifyActualValues("Type", expecedValues, email.Body.Type.ToString(), Site);
        ...
        if (email.BodyPart != null)
        {
            ...
            var expecedValues = new string[] { "1", "176" };
            Common.VerifyActualValues("Status", expecedValues, email.BodyPart.Status.ToString(), Site);
            ...
            if (email.BodyPart.TruncatedSpecified)
            {
                ...
                VerifyBooleanDataType(email.BodyPart.Truncated);
            }
            ...
            VerifyUnsignedByteDataType(email.BodyPart.Type);
        }
        ...
        if (email.Attachments != null)
        {
            ...
            foreach (var obj in email.Attachments.Items)
            {
                if (obj is Response.AttachmentsAttachment)
                {
                    ...
                    var attachment = obj as Response.AttachmentsAttachment;
                    ...
                    VerifyUnsignedByteDataType(attachment.Method);

                    var expecedValues = new string[] { "1", "2", "3", "4", "5", "6" };
                    Common.VerifyActualValues("Method", expecedValues, attachment.Method.ToString(), Site);
                    ...
                    if (attachment.IsInlineSpecified)
                    {
                        ...
                        VerifyBooleanDataType(attachment.IsInline);
        ...
        if (decodedData != null)
        {
            ...
            foreach (var decodeDataItem in decodedData)
            {
                ...
                if (17 == codepage)
                {
                    ...
                    VerifyRequirementsRelateToCodePage17(codepage, tagName, token);
                }
            }
        }
    }
