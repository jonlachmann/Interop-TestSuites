...
public partial class MS_ASAIRSAdapter : ManagedAdapterBase, IMS_ASAIRSAdapter
{
    ...
    public SyncStore Sync(SyncRequest request)
    {
        ...
        VerifySyncResponse(response, syncStore);
        VerifyWBXMLCapture();
    ...
    {
        return activeSyncClient.SendStringRequest(CommandName.Sync, null, request);
    }
    ...
    public ItemOperationsStore ItemOperations(ItemOperationsRequest request, DeliveryMethodForFetch deliveryMethod)
    {
        ...
        VerifyItemOperationsResponse(response, itemOperationsStore);
        VerifyWBXMLCapture();
    ...
    {
        return activeSyncClient.SendStringRequest(CommandName.ItemOperations, null, request);
    }
    ...
    public SearchStore Search(SearchRequest request)
    {
        ...
        VerifySearchResponse(response, searchStore);
        VerifyWBXMLCapture();
    ...
    {
        return activeSyncClient.SendStringRequest(CommandName.Search, null, request);
    }
