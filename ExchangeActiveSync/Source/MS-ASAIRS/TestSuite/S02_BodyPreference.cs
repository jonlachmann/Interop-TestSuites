...
public class S02_BodyPreference : TestSuiteBase
{
    ...
    public void MSASAIRS_S02_TC01_BodyPreference_AllOrNoneTrue_AllContentReturned()
    {
        ...
        var allContentItem = GetAllContentItem(subject, User2Information.InboxCollectionId);
        #endregion
        ...
        VerifyBodyElements(syncItem.Email.Body, true, false, true);
        ...
        var itemOperationsItem = GetItemOperationsResult(User2Information.InboxCollectionId, syncItem.ServerId, null, bodyPreference, null, null);

        VerifyBodyElements(itemOperationsItem.Email.Body, true, false, true);
        ...
        if (Common.IsRequirementEnabled(53, Site))
        {
            ...
            var searchItem = GetSearchResult(subject, User2Information.InboxCollectionId, itemOperationsItem.Email.ConversationId, bodyPreference, null);

            VerifyBodyElements(searchItem.Email.Body, true, false, true);
    ...
    public void MSASAIRS_S02_TC02_BodyPreference_AllOrNoneTrue_AllContentNotReturned()
    {
        ...
        VerifyBodyElements(syncItem.Email.Body, true, true, true);
        ...
        VerifyBodyElements(itemOperationsItem.Email.Body, true, true, true);
        ...
        if (Common.IsRequirementEnabled(53, Site))
        {
            ...
            VerifyBodyElements(searchItem.Email.Body, true, true, true);
    ...
    public void MSASAIRS_S02_TC03_BodyPreference_AllOrNoneFalse_TruncatedContentReturned()
    {
        ...
        VerifyBodyElements(syncItem.Email.Body, false, true, true);
        ...
        VerifyBodyElements(itemOperationsItem.Email.Body, false, true, true);
        ...
        if (Common.IsRequirementEnabled(53, Site))
        {
            ...
            VerifyBodyElements(searchItem.Email.Body, false, true, true);
    ...
    public void MSASAIRS_S02_TC04_BodyPreference_AllOrNoneFalse_NonTruncatedContentReturned()
    {
        ...
        VerifyBodyElements(syncItem.Email.Body, false, false, true);
        ...
        VerifyBodyElements(itemOperationsItem.Email.Body, false, false, true);
        ...
        if (Common.IsRequirementEnabled(53, Site))
        {
            ...
            VerifyBodyElements(searchItem.Email.Body, false, false, true);
    ...
    public void MSASAIRS_S02_TC05_BodyPreference_NoAllOrNone_TruncatedContentReturned()
    {
        ...
        VerifyBodyElements(syncItem.Email.Body, null, true, true);
        ...
        VerifyBodyElements(itemOperationsItem.Email.Body, null, true, true);
        ...
        if (Common.IsRequirementEnabled(53, Site))
        {
            ...
            VerifyBodyElements(searchItem.Email.Body, null, true, true);
    ...
    public void MSASAIRS_S02_TC06_BodyPreference_NoAllOrNone_NonTruncatedContentReturned()
    {
        ...
        VerifyBodyElements(syncItem.Email.Body, null, false, true);
        ...
        VerifyBodyElements(itemOperationsItem.Email.Body, null, false, true);
        ...
        if (Common.IsRequirementEnabled(53, Site))
        {
            ...
            VerifyBodyElements(searchItem.Email.Body, null, false, true);
    ...
    public void MSASAIRS_S02_TC07_BodyPreference_NotIncludedTruncationSize()
    {
        ...
        #region Set BodyPreference element
        var bodyPreferenceAllOrNoneTrue = new Request.BodyPreference[]
        {
            new Request.BodyPreference()
            {
                Type = 1,
        ...
        var bodyPreferenceAllOrNoneFalse = new Request.BodyPreference[]
        {
            new Request.BodyPreference()
            {
                Type = 1,
        ...
        var syncItemAllOrNoneTrue = GetSyncResult(subject, User2Information.InboxCollectionId, null, bodyPreferenceAllOrNoneTrue, null);

        VerifyBodyElements(syncItemAllOrNoneTrue.Email.Body, true, false, false);

        // Call Sync command with AllOrNone setting to FALSE
        var syncItemAllOrNoneFalse = GetSyncResult(subject, User2Information.InboxCollectionId, null, bodyPreferenceAllOrNoneFalse, null);

        VerifyBodyElements(syncItemAllOrNoneFalse.Email.Body, false, false, false);
        ...
        var itemOperationsItemAllOrNoneTrue = GetItemOperationsResult(User2Information.InboxCollectionId, syncItemAllOrNoneTrue.ServerId, null, bodyPreferenceAllOrNoneTrue, null, null);

        VerifyBodyElements(itemOperationsItemAllOrNoneTrue.Email.Body, true, false, false);

        // Call ItemOperations command with AllOrNone setting to false
        var itemOperationsItemAllOrNoneFalse = GetItemOperationsResult(User2Information.InboxCollectionId, syncItemAllOrNoneTrue.ServerId, null, bodyPreferenceAllOrNoneFalse, null, null);

        VerifyBodyElements(itemOperationsItemAllOrNoneFalse.Email.Body, false, false, false);
        ...
        if (Common.IsRequirementEnabled(53, Site))
        {
            ...
            var searchItemAllNoneTrue = GetSearchResult(subject, User2Information.InboxCollectionId, itemOperationsItemAllOrNoneTrue.Email.ConversationId, bodyPreferenceAllOrNoneTrue, null);

            VerifyBodyElements(searchItemAllNoneTrue.Email.Body, true, false, false);

            // Call Search command with AllOrNone setting to false
            var searchItemAllNoneFalse = GetSearchResult(subject, User2Information.InboxCollectionId, itemOperationsItemAllOrNoneTrue.Email.ConversationId, bodyPreferenceAllOrNoneFalse, null);

            VerifyBodyElements(searchItemAllNoneFalse.Email.Body, false, false, false);
    ...
    public void MSASAIRS_S02_TC08_MultipleBodyPreference()
    {
        ...
        #region Set BodyPreference element
        var bodyPreferences = new Request.BodyPreference[2]
        {
            new Request.BodyPreference()
            {
                Type = 2,
        ...
        #region Verify Sync command related elements
        var syncItem = GetSyncResult(subject, User2Information.InboxCollectionId, null, bodyPreferences, null);

        VerifyMultipleBodyPreference(syncItem.Email, body, bodyPreferences);
        #endregion

        #region Verify ItemOperations command related elements
        var itemOperationsItem = GetItemOperationsResult(User2Information.InboxCollectionId, syncItem.ServerId, null, bodyPreferences, null, null);

        VerifyMultipleBodyPreference(itemOperationsItem.Email, body, bodyPreferences);
        #endregion

        if (Common.IsRequirementEnabled(53, Site))
        {
            #region Verify Search command related elements
            var searchItem = GetSearchResult(subject, User2Information.InboxCollectionId, itemOperationsItem.Email.ConversationId, bodyPreferences, null);

            VerifyMultipleBodyPreference(searchItem.Email, body, bodyPreferences);
            #endregion
        }
    ...
    {
        Site.Assume.AreNotEqual<string>("12.1", Common.GetConfigurationPropertyValue("ActiveSyncProtocolVersion", Site), "The Preview element is not supported when the MS-ASProtocolVersion header is set to 12.1. MS-ASProtocolVersion header value is determined using Common PTFConfig property named ActiveSyncProtocolVersion.");
        ...
        VerifyBodyPreview(syncItem.Email, allContentItem.Email, bodyPreference);
        #endregion

        #region Verify ItemOperations command related elements
        var itemOperationsItem = GetItemOperationsResult(User2Information.InboxCollectionId, syncItem.ServerId, null, bodyPreference, null, null);

        VerifyBodyPreview(itemOperationsItem.Email, allContentItem.Email, bodyPreference);
        #endregion
        ...
        if (Common.IsRequirementEnabled(53, Site))
        {
            ...
            VerifyBodyPreview(searchItem.Email, allContentItem.Email, bodyPreference);
            #endregion
        }
        ...
        #region Verify Sync command related elements
        syncItem = GetSyncResult(subject, User2Information.InboxCollectionId, null, bodyPreference, null);
        VerifyBodyPreview(syncItem.Email, allContentItem.Email, bodyPreference);
        #endregion
    }
    #endregion
    ...
    public void MSASAIRS_S02_TC10_IncludedBodyInResponse()
    {
        ...
        #region Verify Sync command related elements
        var syncItem = GetSyncResult(subject, User2Information.InboxCollectionId, null, null, null);
        ...
        var itemOperationsItem = GetItemOperationsResult(User2Information.InboxCollectionId, syncItem.ServerId, null, null, null, null);
        ...
        var updatedSyncItem = GetSyncResult(subject, User2Information.InboxCollectionId, null, null, null);
        ...
        var updatedItemOperationItem = GetItemOperationsResult(User2Information.InboxCollectionId, updatedSyncItem.ServerId, null, null, null, null);
        ...
        {
            #region Verify Search command related elements
            var searchItem = GetSearchResult(subject, User2Information.InboxCollectionId, itemOperationsItem.Email.ConversationId, null, null);
            ...
            var updateSearchItem = GetSearchResult(subject, User2Information.InboxCollectionId, updatedItemOperationItem.Email.ConversationId, null, null);
    ...
    {
        var isTruncatedSupported = Common.GetConfigurationPropertyValue("ActiveSyncProtocolVersion", Site).Equals("12.1")
        ...
        var data = Common.GenerateResourceName(Site, "ContactData");

        var fileAsWithoutTruncated = Common.GenerateResourceName(Site, "ContactWithoutTruncated");
        var syncAdd = CreateSyncAddContact(fileAsWithoutTruncated, data, null);
        commandList.Add(syncAdd);

        var fileAsWithTruncatedTrue = Common.GenerateResourceName(Site, "ContactWithTruncatedTrue");
        syncAdd = CreateSyncAddContact(fileAsWithTruncatedTrue, data, true);
        commandList.Add(syncAdd);

        var fileAsWithTruncatedFalse = Common.GenerateResourceName(Site, "ContactWithTruncatedFalse");
        syncAdd = CreateSyncAddContact(fileAsWithTruncatedFalse, data, false);
        commandList.Add(syncAdd);

        var syncAddRequest = TestSuiteHelper.CreateSyncRequest(GetInitialSyncKey(User1Information.ContactsCollectionId), User1Information.ContactsCollectionId, commandList.ToArray(), null, null);
        ...
        RecordCaseRelativeItems(User1Information.UserName, User1Information.ContactsCollectionId, fileAsWithoutTruncated, fileAsWithTruncatedTrue, fileAsWithTruncatedFalse);
        #endregion
        ...
        var syncRequest = TestSuiteHelper.CreateSyncRequest(GetInitialSyncKey(User1Information.ContactsCollectionId), User1Information.ContactsCollectionId, null, bodyPreference, null);

        var contacts = ASAIRSAdapter.Sync(syncRequest);

        var contactWithoutTruncated = TestSuiteHelper.GetSyncAddItem(contacts, fileAsWithoutTruncated);
        VerifySyncItem(contactWithoutTruncated);

        var contactWithTruncatedTrue = TestSuiteHelper.GetSyncAddItem(contacts, fileAsWithTruncatedTrue);
        VerifySyncItem(contactWithTruncatedTrue);

        var contactWithTruncatedFalse = TestSuiteHelper.GetSyncAddItem(contacts, fileAsWithTruncatedFalse);
        VerifySyncItem(contactWithTruncatedFalse);
    ...
    public void MSASAIRS_S02_TC12_NativeBodyTypeAndType_RTF()
    {
        ...
        var subject = Common.GenerateResourceName(Site, "Subject");
        var body = Common.GenerateResourceName(Site, "Body");
        SendEmail(EmailType.AttachOLE, subject, body);
        #endregion
        ...
        VerifyType(syncItem.Email, bodyPreference[0].Type);
        ...
        VerifyType(itemOperationsItem.Email, bodyPreference[0].Type);
        #endregion
        ...
        if (Common.IsRequirementEnabled(53, Site))
        {
            ...
            VerifyType(searchItem.Email, bodyPreference[0].Type);
    ...
    public void MSASAIRS_S02_TC13_NativeBodyTypeAndType_HTML()
    {
        ...
        var subject = Common.GenerateResourceName(Site, "Subject");
        var body = Common.GenerateResourceName(Site, "Body");
        SendEmail(EmailType.HTML, subject, body);
        #endregion
        ...
        var bodyPreferenceWithType4 = new Request.BodyPreference[]
        {
            new Request.BodyPreference()
            {
                Type = 4
        ...
        #region Verify ItemOperations command
        var itemOperationsItem = GetItemOperationsResult(User2Information.InboxCollectionId, syncItem.ServerId, null, bodyPreference, null, DeliveryMethodForFetch.Inline);
        ...
        {
            #region Verify Search command
            var searchItem = GetSearchResult(subject, User2Information.InboxCollectionId, null, bodyPreference, null);
        ...
        var syncItemWithType4 = GetSyncResult(subject, User2Information.InboxCollectionId, null, bodyPreferenceWithType4, null);
    ...
    public void MSASAIRS_S02_TC14_ItemOperations_Part()
    {
        ...
        #region Set BodyPReference element
        var bodyPreferences = new Request.BodyPreference[]
        {
            new Request.BodyPreference
            {
                Type = 4
        ...
        var itemOperationsItemInline = GetItemOperationsResult(User2Information.InboxCollectionId, syncItem.ServerId, null, bodyPreferences, null, DeliveryMethodForFetch.Inline);
        ...
        var itemOperationsItemMultiPart = GetItemOperationsResult(User2Information.InboxCollectionId, syncItem.ServerId, null, bodyPreferences, null, DeliveryMethodForFetch.MultiPart);
    ...
    {
        var syncAdd = new Request.SyncCollectionAdd { ClientId = Guid.NewGuid().ToString("N") };
        ...
        var addBody = new Request.Body { Type = 1, Data = data };
