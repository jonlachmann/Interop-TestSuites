...
public class S01_BodyPartPreference : TestSuiteBase
{
    ...
    {
        Site.Assume.AreNotEqual<string>("12.1", Common.GetConfigurationPropertyValue("ActiveSyncProtocolVersion", Site), "The BodyPartPreference element is not supported when the MS-ASProtocolVersion header is set to 12.1. MS-ASProtocolVersion header value is determined using Common PTFConfig property named ActiveSyncProtocolVersion.");
        Site.Assume.AreNotEqual<string>("14.0", Common.GetConfigurationPropertyValue("ActiveSyncProtocolVersion", Site), "The BodyPartPreference element is not supported when the MS-ASProtocolVersion header is set to 14.0. MS-ASProtocolVersion header value is determined using Common PTFConfig property named ActiveSyncProtocolVersion.");
        ...
        var syncItem = GetSyncResult(subject, User2Information.InboxCollectionId, null, null, bodyPartPreference);

        VerifyBodyPartElements(syncItem.Email.BodyPart, true, false, true);
        ...
        var itemOperationsItem = GetItemOperationsResult(User2Information.InboxCollectionId, syncItem.ServerId, null, null, bodyPartPreference, null);

        VerifyBodyPartElements(itemOperationsItem.Email.BodyPart, true, false, true);
        ...
        if (Common.IsRequirementEnabled(53, Site))
        {
            ...
            var searchItem = GetSearchResult(subject, User2Information.InboxCollectionId, itemOperationsItem.Email.ConversationId, null, bodyPartPreference);

            VerifyBodyPartElements(searchItem.Email.BodyPart, true, false, true);
    ...
    public void MSASAIRS_S01_TC02_BodyPartPreference_AllOrNoneTrue_AllContentNotReturned()
    {
        ...
        VerifyBodyPartElements(syncItem.Email.BodyPart, true, true, true);
        ...
        VerifyBodyPartElements(itemOperationsItem.Email.BodyPart, true, true, true);
        ...
        { 
            ...
            VerifyBodyPartElements(searchItem.Email.BodyPart, true, true, true);
    ...
    public void MSASAIRS_S01_TC03_BodyPartPreference_AllOrNoneFalse_TruncatedContentReturned()
    {
        ...
        GetAllContentItem(subject, User2Information.InboxCollectionId);
        var lastRawResponse = (XmlElement)ASAIRSAdapter.LastRawResponseXml;
        ...
        #region Verify Sync command related elements
        var syncItem = GetSyncResult(subject, User2Information.InboxCollectionId, null, null, bodyPartPreference);
        lastRawResponse = (XmlElement)ASAIRSAdapter.LastRawResponseXml;

        VerifyBodyPartElements(syncItem.Email.BodyPart, false, true, true);
        ...
        VerifyBodyPartElements(itemOperationsItem.Email.BodyPart, false, true, true);
        ...
        if (Common.IsRequirementEnabled(53, Site))
        {
            ...
            VerifyBodyPartElements(searchItem.Email.BodyPart, false, true, true);
    ...
    public void MSASAIRS_S01_TC04_BodyPartPreference_AllOrNoneFalse_NonTruncatedContentReturned()
    {
        ...
        VerifyBodyPartElements(syncItem.Email.BodyPart, false, false, true);
        ...
        VerifyBodyPartElements(itemOperationsItem.Email.BodyPart, false, false, true);
        ...
        {          
            ...
            VerifyBodyPartElements(searchItem.Email.BodyPart, false, false, true);
    ...
    public void MSASAIRS_S01_TC05_BodyPartPreference_NoAllOrNone_TruncatedContentReturned()
    {
        ...
        VerifyBodyPartElements(syncItem.Email.BodyPart, null, true, true);
        ...
        VerifyBodyPartElements(itemOperationsItem.Email.BodyPart, null, true, true);
        ...
        if (Common.IsRequirementEnabled(53, Site))
        {
            ...
            VerifyBodyPartElements(searchItem.Email.BodyPart, null, true, true);
    ...
    public void MSASAIRS_S01_TC06_BodyPartPreference_NoAllOrNone_NonTruncatedContentReturned()
    {
        ...
        VerifyBodyPartElements(syncItem.Email.BodyPart, null, false, true);
        ...
        VerifyBodyPartElements(itemOperationsItem.Email.BodyPart, null, false, true);
        ...
        if (Common.IsRequirementEnabled(53, Site))
        {
            ...
            VerifyBodyPartElements(searchItem.Email.BodyPart, null, false, true);
    ...
    public void MSASAIRS_S01_TC07_BodyPartPreference_NotIncludedTruncationSize()
    {
        ...
        #region Set BodyPartPreference element
        var bodyPartPreferenceAllOrNoneTrue = new Request.BodyPartPreference[]
        {
            new Request.BodyPartPreference()
            {
                Type = 2,
        ...
        var bodyPartPreferenceAllOrNoneFalse = new Request.BodyPartPreference[]
        {
            new Request.BodyPartPreference()
            {
                Type = 2,
        ...
        var syncItemAllOrNoneTrue = GetSyncResult(subject, User2Information.InboxCollectionId, null, null, bodyPartPreferenceAllOrNoneTrue);

        VerifyBodyPartElements(syncItemAllOrNoneTrue.Email.BodyPart, true, false, false);

        // Call Sync command with AllOrNone setting to FALSE
        var syncItemAllOrNoneFalse = GetSyncResult(subject, User2Information.InboxCollectionId, null, null, bodyPartPreferenceAllOrNoneFalse);

        VerifyBodyPartElements(syncItemAllOrNoneFalse.Email.BodyPart, false, false, false);
        ...
        var itemOperationsItemAllOrNoneTrue = GetItemOperationsResult(User2Information.InboxCollectionId, syncItemAllOrNoneTrue.ServerId, null, null, bodyPartPreferenceAllOrNoneTrue, null);

        VerifyBodyPartElements(itemOperationsItemAllOrNoneTrue.Email.BodyPart, true, false, false);

        // Call ItemOperations command with AllOrNone setting to false
        var itemOperationsItemAllOrNoneFalse = GetItemOperationsResult(User2Information.InboxCollectionId, syncItemAllOrNoneTrue.ServerId, null, null, bodyPartPreferenceAllOrNoneFalse, null);

        VerifyBodyPartElements(itemOperationsItemAllOrNoneFalse.Email.BodyPart, false, false, false);
        ...
        if (Common.IsRequirementEnabled(53, Site))
        {
            ...
            var searchItemAllNoneTrue = GetSearchResult(subject, User2Information.InboxCollectionId, itemOperationsItemAllOrNoneTrue.Email.ConversationId, null, bodyPartPreferenceAllOrNoneTrue);

            VerifyBodyPartElements(searchItemAllNoneTrue.Email.BodyPart, true, false, false);

            // Call Search command with AllOrNone setting to false
            var searchItemAllNoneFalse = GetSearchResult(subject, User2Information.InboxCollectionId, itemOperationsItemAllOrNoneTrue.Email.ConversationId, null, bodyPartPreferenceAllOrNoneFalse);

            VerifyBodyPartElements(searchItemAllNoneFalse.Email.BodyPart, false, false, false);
    ...
    public void MSASAIRS_S01_TC08_BodyPart_Preview()
    {
        ...
        VerifyBodyPartPreview(syncItem.Email, allContentItem.Email, bodyPartPreference);
        #endregion

        #region Verify ItemOperations command related elements
        var itemOperationsItem = GetItemOperationsResult(User2Information.InboxCollectionId, syncItem.ServerId, null, null, bodyPartPreference, null);

        VerifyBodyPartPreview(itemOperationsItem.Email, allContentItem.Email, bodyPartPreference);
        #endregion
        ...
        if (Common.IsRequirementEnabled(53, Site))
        {
            ...
            VerifyBodyPartPreview(searchItem.Email, allContentItem.Email, bodyPartPreference);
            #endregion
        }
    ...
    private void VerifyBodyPartElements(BodyPart bodyPart, bool? allOrNone, bool truncated, bool includedTruncationSize)
    {
        ...
        {
            if (Common.IsRequirementEnabled(403, Site))
            {
                // Add the debug information
