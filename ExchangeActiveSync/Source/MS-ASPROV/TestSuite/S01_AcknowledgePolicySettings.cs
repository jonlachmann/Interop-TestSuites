...
public class S01_AcknowledgePolicySettings : TestSuiteBase
{
    ...
    public void MSASPROV_S01_TC01_AcknowledgeSecurityPolicySettings()
    {
        ...
        var policy = provisionResponse.ResponseData.Policies.Policy;
        ...
        var isR441Verified = provisionResponse.ResponseData.Policies != null && provisionResponse.ResponseData.Status == 1;
    ...
    public void MSASPROV_S01_TC02_WithoutAcknowledgingSecurityPolicySettings()
    {
        ...
        if (Common.IsRequirementEnabled(509, Site))
        {
            // Add the debug information
    ...
    public void MSASPROV_S01_TC03_InitialPreviouslySettingUnset()
    {
        ...
        if (Common.IsRequirementEnabled(1044, Site))
        {
        ...
        if (Common.IsRequirementEnabled(1045, Site))
        {
