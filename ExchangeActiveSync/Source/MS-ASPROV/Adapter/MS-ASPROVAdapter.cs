...
public partial class MS_ASPROVAdapter : ManagedAdapterBase, IMS_ASPROVAdapter
{
    ...
    {
        activeSyncClient.DeviceType = appliedDeviceType;
    }
    ...
    {
        var provisionResponse = activeSyncClient.Provision(provisionRequest);
        ...
        VerifyProvisionCommandRequirements(provisionResponse);
    ...
    public SyncStore Sync(SyncRequest syncRequest)
    {
        ...
        var syncResult = Common.LoadSyncResponse(response);
        return syncResult;
    }
    ...
    {
        var provisionStringResponse = activeSyncClient.SendStringRequest(CommandName.Provision, null, provisionRequest);
