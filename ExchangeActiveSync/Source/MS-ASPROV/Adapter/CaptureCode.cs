...
AccountOnlyRemoteWipe (section 2.2.2.1).");
        ...
        VerifyUnsignedByteStructure(provisionResponse.ResponseData.Status);

        if (provisionResponse.ResponseData.Status < 100)
        {
            var isVerifiedR393 = provisionResponse.ResponseData.Status == 1 || provisionResponse.ResponseData.Status == 2 || provisionResponse.ResponseData.Status == 3;
        ...
        if (null != provisionResponse.ResponseData.Policies)
        {
            ...
            if (null != provisionResponse.ResponseData.Policies.Policy.PolicyType)
            {
                ...
                if (provisionResponse.ResponseData.Policies.Policy.Status != 3)
                {
                    ...
                    var isR318Satisfied = provisionResponse.ResponseData.Policies.Policy.PolicyType.Equals("MS-WAP-Provisioning-XML") || provisionResponse.ResponseData.Policies.Policy.PolicyType.Equals("MS-EAS-Provisioning-WBXML");
...
MS-EAS-Provisioning-WBXML]");
            ...
            VerifyUnsignedByteStructure(provisionResponse.ResponseData.Policies.Policy.Status);
...
UnapprovedInROMApplicationList (section 2.2.2.55)");
                ...
                VerifyEASProvisionDocElement(provisionResponse);
...
<Provision>
   ...
   <RemoteWipe/>
    ...
    private void VerifyEASProvisionDocElement(ProvisionResponse provisionResponse)
    {
        ...
        var policiesSetting = AdapterHelper.GetPoliciesFromProvisionResponse(provisionResponse);
        ...
        if (policiesSetting.ContainsKey("AllowBluetooth"))
        {
            ...
            VerifyUnsignedByteStructure(provisionResponse.ResponseData.Policies.Policy.Data.EASProvisionDoc.AllowBluetooth);
        }
...
<xs:simpleType name=""unsignedByteOrEmpty"">
  <xs:union memberTypes=""xs:unsignedByte EmptyVal""/>
        ...
        if (policiesSetting.ContainsKey("MaxEmailBodyTruncationSize"))
        {
            ...
            var isVerifiedR266 = Convert.ToInt32(provisionResponse.ResponseData.Policies.Policy.Data.EASProvisionDoc.MaxEmailBodyTruncationSize) >= -1;
        ...
        if (policiesSetting.ContainsKey("MaxEmailHTMLBodyTruncationSize"))
        {
            ...
            var isVerifiedR272 = Convert.ToInt32(provisionResponse.ResponseData.Policies.Policy.Data.EASProvisionDoc.MaxEmailHTMLBodyTruncationSize) >= -1;
        ...
        if (policiesSetting.ContainsKey("MinDevicePasswordComplexCharacters"))
        {
            ...
            VerifyUnsignedByteStructure(provisionResponse.ResponseData.Policies.Policy.Data.EASProvisionDoc.MinDevicePasswordComplexCharacters);
        }
