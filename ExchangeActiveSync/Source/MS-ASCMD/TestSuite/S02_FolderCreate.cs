...
public class S02_FolderCreate : TestSuiteBase
{
    ...
    public void MSASCMD_S02_TC02_FolderCreate_Fail()
    {
        ...
        var folderCreateResponse = GetFolderCreateResponse(LastFolderSyncKey, (byte)FolderType.UserCreatedMail, string.Empty, "0");
    ...
    public void MSASCMD_S02_TC03_FolderCreate_Status2()
    {
        ...
        var folderName = Common.GenerateResourceName(Site, "FolderCreate", 1);
    ...
    public void MSASCMD_S02_TC04_FolderCreate_Status5()
    {
        ...
        var folderCreateResponse = GetFolderCreateResponse(LastFolderSyncKey, (byte)FolderType.UserCreatedMail, Common.GenerateResourceName(Site, "FolderCreate"), "InvalidParentId");
    ...
    public void MSASCMD_S02_TC05_FolderCreate_Status9()
    {
        ...
        var folderCreateResponse = GetFolderCreateResponse("InvalidFolderSyncKey", (byte)FolderType.UserCreatedMail, Common.GenerateResourceName(Site, "FolderCreate"), "0");
    ...
    public void MSASCMD_S02_TC06_FolderCreate_Status10()
    {
        ...
        var folderCreateResponse = GetFolderCreateResponse(null, (byte)FolderType.UserCreatedMail, Common.GenerateResourceName(Site, "FolderCreate"), "0");
        ...
        folderCreateResponse = GetFolderCreateResponse(LastFolderSyncKey, (byte)FolderType.Inbox, Common.GenerateResourceName(Site, "FolderCreate"), "0");
    ...
    public void MSASCMD_S02_TC07_FolderCreate_Status3()
    {
        ...
        var folderCreateResponse = GetFolderCreateResponse(LastFolderSyncKey, (byte)FolderType.UserCreatedMail, Common.GenerateResourceName(Site, "FolderCreate"), User1Information.RecipientInformationCacheCollectionId);
    ...
    public void MSASCMD_S02_TC08_FolderCreate_RecipientInformationCache_Status3()
    {
        ...
        // Set the specified parent folder is the recipient information cache
        var folderCreateResponse = GetFolderCreateResponse(LastFolderSyncKey, (byte)FolderType.RecipientInformationCache, Common.GenerateResourceName(Site, "FolderCreate"), User1Information.InboxCollectionId);
