...
public class S15_SendMail : TestSuiteBase
{
    ...
    public void MSASCMD_S15_TC01_SendMail_Success()
    {
        ...
        var sendMailResponse = SendPlainTextEmail(null, emailSubject, User1Information.UserName, User2Information.UserName, null);
        #endregion
        ...
        var syncResponse = GetMailItem(User2Information.InboxCollectionId, emailSubject);
    ...
    public void MSASCMD_S15_TC02_SendMail_AccountIdInvalid()
    {
        ...
        var responseSendMail = SendPlainTextEmail("InvalidValueAccountID", emailSubject, User1Information.UserName, User2Information.UserName, null);
        #endregion
