...
public class S08_ItemOperations : TestSuiteBase
{
    ...
    public void MSASCMD_S08_TC01_ItemOperations_DeleteSubFolders()
    {
        ...
        var subFolderName = Common.GenerateResourceName(Site, "subfolder");
        var folderCreateRequest = Common.CreateFolderCreateRequest(LastFolderSyncKey, (byte)FolderType.UserCreatedMail, subFolderName, User1Information.InboxCollectionId);
        ...
        var subFolderId = Common.GetDefaultFolderServerId(folderSyncResponse, FolderType.UserCreatedMail, Site);
        ...
        var itemOperationsRequest = new ItemOperationsRequest
        {
        ...
        {
            if (folderChangesAdd.DisplayName == subFolderName && folderChangesAdd.ParentId == User1Information.InboxCollectionId)
            {
        ...
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCMD_R2167, Expected subfolder name: {0}, parent folder's CollectionId: {1}, subfolder's ServerId: {2}", subFolderName, User1Information.InboxCollectionId, subFolderId);
    ...
    public void MSASCMD_S08_TC03_ItemOperations_Status9()
    {
        ...
        var itemOperationsRequest = CreateItemOperationsRequestWithFetchElement(User1Information.InboxCollectionId, "InvalidStore", string.Empty, null);
        var itemOperationsResponse = CMDAdapter.ItemOperations(itemOperationsRequest, DeliveryMethodForFetch.Inline);
        var fetch = GetFetchElement(itemOperationsResponse);
    ...
    public void MSASCMD_S08_TC04_ItemOperations_Status6()
    {
        ...
        var itemOperationsRequest = CreateItemOperationsRequestWithFetchElement(User1Information.InboxCollectionId, SearchName.Mailbox.ToString(), "InvalidServerID", null);
        var itemOperationsResponse = CMDAdapter.ItemOperations(itemOperationsRequest, DeliveryMethodForFetch.Inline);
        var fetch = GetFetchElement(itemOperationsResponse);
    ...
    public void MSASCMD_S08_TC05_ItemOperations_Fetch()
    {
        ...
        var syncResponse = GetMailItem(User1Information.InboxCollectionId, subject);
        var serverId = FindServerId(syncResponse, "Subject", subject);
        #endregion

        #region Call method ItemOperations which contains the Fetch element.
        var itemOperationsRequest = CreateItemOperationsRequestWithFetchElement(User1Information.InboxCollectionId, SearchName.Mailbox.ToString(), serverId, null);
        var itemOperationsResponse = CMDAdapter.ItemOperations(itemOperationsRequest, DeliveryMethodForFetch.Inline);
    ...
    {
        Site.Assume.AreNotEqual<string>("12.1", Common.GetConfigurationPropertyValue("ActiveSyncProtocolVersion", Site), "The Move element is not supported when the MS-ASProtocolVersion header is set to 12.1. MS-ASProtocolVersion header value is determined using Common PTFConfig property named ActiveSyncProtocolVersion.");
        ...
        var serverId = FindServerId(syncResponse, "Subject", subject);
        var conversationId = GetConverstationIdFromSyncResposne(syncResponse, serverId);
        #endregion
        ...
        syncResponse = GetMailItem(User1Information.DeletedItemsCollectionId, subject);
        ...
        RemoveRecordCaseRelativeItems(User1Information, User1Information.InboxCollectionId, subject);
        RecordCaseRelativeItems(User1Information, User1Information.DeletedItemsCollectionId, subject);
    ...
    public void MSASCMD_S08_TC07_ItemOperations_MultiplePartResponse()
    {
        ...
        var itemOperationsRequest = CreateItemOperationsRequestWithFetchElement(User1Information.InboxCollectionId, SearchName.Mailbox.ToString(), serverId, null);
        var itemOperationsResponse = CMDAdapter.ItemOperations(itemOperationsRequest, DeliveryMethodForFetch.MultiPart);
        ...
        var parts = new byte[itemOperationsResponse.MultipartMetadata.PartsMetaData.Length][];
        for (var partsIndex = 0; partsIndex < itemOperationsResponse.MultipartMetadata.PartsMetaData.Length; partsIndex++)
        {
            ...
            Array.Copy(itemOperationsResponse.RawBody, itemOperationsResponse.MultipartMetadata.PartsMetaData[partsIndex].Start, parts[partsIndex], 0, itemOperationsResponse.MultipartMetadata.PartsMetaData[partsIndex].Count);
    ...
    public void MSASCMD_S08_TC08_ItemOperations_Fetch_MIMESupport()
    {
        ...
        var lastRawResponse = (XmlElement)CMDAdapter.LastRawResponseXml;
        var data = GetElementInnerText(lastRawResponse, "Body", "Data", subject);
        ...
        var sendStringResponse = CMDAdapter.SendStringRequest(CommandName.ItemOperations, null, request);
        ...
        var xmlElement = (XmlElement)doc.DocumentElement;
        var defaultData = GetElementInnerText(xmlElement, "Body", "Data", subject);
        ...
        itemOperationsResponse = CMDAdapter.ItemOperations(itemOperationsRequest, DeliveryMethodForFetch.MultiPart);
        body = GetBodyElement(itemOperationsResponse);
    ...
    public void MSASCMD_S08_TC10_ItemOperations_EmptyFolderContents()
    {
        ...
        var folderId = CreateFolder((byte)FolderType.UserCreatedContacts, Common.GenerateResourceName(Site, "FolderCreate"), User1Information.ContactsCollectionId);
        ...
        RemoveRecordCaseRelativeItems(User1Information, folderId, contactFileAS);
        #endregion
    }
    ...
    public void MSASCMD_S08_TC11_ItemOperations_Fetch_DocumentLibrary()
    {
        ...
        {
            LinkId = Common.GetConfigurationPropertyValue("SharedDocument1", Site),
        ...
        var itemOperationsResponse = CMDAdapter.ItemOperations(itemOperationsRequest, DeliveryMethodForFetch.Inline);
        var data = GetDataElement(itemOperationsResponse);
        ...
        var existVersionElement = false;

        for (var i = 0; i < itemOperationsResponse.ResponseData.Response.Fetch[0].Properties.ItemsElementName.Length; i++)
        {
        ...
        var contentLength = 0;
        for (var i = 1; i < itemOperationsResponse.MultipartMetadata.PartsMetaData.Length; i++)
        {
    ...
    public void MSASCMD_S08_TC12_ItemOperations_Status4()
    {
        ...
        // Initialize a Fetch element.
        var itemOperationsFetch = new Request.ItemOperationsFetch
        {
            LinkId = "//invalidURI",
            Store = SearchName.DocumentLibrary.ToString(),
            Options = new Request.ItemOperationsFetchOptions
    ...
    public void MSASCMD_S08_TC15_ItemOperations_Status10()
    {
        ...
        var itemOperationsFetch = new Request.ItemOperationsFetch
        {
            LinkId = Common.GetConfigurationPropertyValue("SharedDocument2", Site),
            Store = SearchName.DocumentLibrary.ToString(),
            Options = new Request.ItemOperationsFetchOptions
            {
                ItemsElementName = new Request.ItemsChoiceType5[] { Request.ItemsChoiceType5.UserName, Request.ItemsChoiceType5.Password },
    ...
    public void MSASCMD_S08_TC18_ItemOperations_MoreThanOneFileReference_Status2()
    {
        ...
        for (var i = 0; i < collection.ItemsElementName.Length; i++)
        {
            ...
            {
                var commands = ((Response.SyncCollections)syncResponse.ResponseData.Item).Collection[0].Items[i] as Response.SyncCollectionsCollectionCommands;
                foreach (var add in commands.Add)
                {
                    if (add.ServerId.Equals(serverId))
                    {
                        for (var j = 0; j < add.ApplicationData.ItemsElementName.Length; j++)
                        {
        ...
        var xmlResponse = sendStringResponse.ResponseDataXML;
        var doc = new XmlDocument();
        doc.LoadXml(xmlResponse);
        var xmlNameSpaceManager = new XmlNamespaceManager(doc.NameTable);
        xmlNameSpaceManager.AddNamespace("e", "ItemOperations");
        var statusNode = doc.SelectSingleNode("/e:ItemOperations/e:Status", xmlNameSpaceManager);
        ...
        var itemOperationsRequest = new ItemOperationsRequest
        {
            RequestData = new Request.ItemOperations
            {
                Items = new object[]
                {
                    ...
                    {
                        ConversationId = conversationId,
                        DstFldId = User1Information.NotesCollectionId,
                        Options = new Request.ItemOperationsMoveOptions
                        {
                            MoveAlways = string.Empty
                        }
    ...
    {
        Site.Assume.AreNotEqual<string>("12.1", Common.GetConfigurationPropertyValue("ActiveSyncProtocolVersion", Site), "Recipient Information cache is not supported when MS-ASProtocolVersion is 12.1. MS-ASProtocolVersion header value is determined using Common PTFConfig property named ActiveSyncProtocolVersion.");
    ...
    {
        var index = 0;
        foreach (var item in ((Response.SyncCollections)syncResponse.ResponseData.Item).Collection[0].ItemsElementName)
        {
            if (item == Response.ItemsChoiceType10.Commands)
            {
                var commands = ((Response.SyncCollections)syncResponse.ResponseData.Item).Collection[0].Items[index] as Response.SyncCollectionsCollectionCommands;
                foreach (var add in commands.Add)
                {
                    if (add.ServerId.Equals(serverId))
                    {
    ...
    private static string GetElementInnerText(XmlElement lastRawResponse, string parentNodeName, string nodeName, string subject)
    {
        ...
        var subjectElementNodes = doc.SelectNodes("//*[name()='Subject']");
        for (var i = 0; i < subjectElementNodes.Count; i++)
        {
            if (subjectElementNodes[i].InnerText == subject)
            {
                var bodyElementNodes = doc.SelectNodes("//*[name()='" + parentNodeName + "']");
                var dataElementNodes = bodyElementNodes[i].SelectNodes("*[name()='" + nodeName + "']");
    ...
    private Response.Body GetBodyElement(ItemOperationsResponse itemOperationsResponse)
    {
        ...
        foreach (var tempObject in itemOperationsResponse.ResponseData.Response.Fetch[0].Properties.Items)
        {
    ...
    private string GetDataElement(ItemOperationsResponse itemOperationsResponse)
    {
        ...
        Site.Assert.IsTrue(User1Information.UserPassword.Length <= 256, "The expected length of password should be not larger than 256, the actual length is: {0}", User1Information.UserPassword.Length);
        ...
        for (var i = 0; i < fetch.Properties.ItemsElementName.Length; i++)
        {
