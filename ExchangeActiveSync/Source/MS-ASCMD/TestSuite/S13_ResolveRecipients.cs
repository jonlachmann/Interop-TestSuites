...
public class S13_ResolveRecipients : TestSuiteBase
{
    ...
    {
        Site.Assume.AreNotEqual<string>("12.1", Common.GetConfigurationPropertyValue("ActiveSyncProtocolVersion", Site), "The EndTime element is not supported when the MS-ASProtocolVersion header is set to 12.1. MS-ASProtocolVersion header value is determined using Common PTFConfig property named ActiveSyncProtocolVersion.");
    ...
    {
        Site.Assume.AreNotEqual<string>("12.1", Common.GetConfigurationPropertyValue("ActiveSyncProtocolVersion", Site), "The StartTime element is not supported when the MS-ASProtocolVersion header is set to 12.1. MS-ASProtocolVersion header value is determined using Common PTFConfig property named ActiveSyncProtocolVersion.");
    ...
    public void MSASCMD_S13_TC05_ResolveRecipients_DurationIsTooLarge()
    {
        ...
        if (Common.IsRequirementEnabled(5175, Site))
        {
            // Add the debug information
    ...
    public void MSASCMD_S13_TC06_ResolveRecipients_Over256()
    {
        ...
        var toElementWith256Chars = CreateFixedLengthString(256);
        var resolveRecipientsRequest = new ResolveRecipientsRequest
        {
            RequestData = new Request.ResolveRecipients
            {
        ...
        var resolveRecipientsResponse = CMDAdapter.ResolveRecipients(resolveRecipientsRequest);
        var status256 = int.Parse(resolveRecipientsResponse.ResponseData.Status);
        #endregion

        #region The client calls ResolveRecipients command with To elements value length of 257.
        var toElementWith257Chars = CreateFixedLengthString(257);
        var resolveRecipientsRequest257 = new ResolveRecipientsRequest
        {
            RequestData = new Request.ResolveRecipients
            {
                Items = new object[]
        ...
        var resolveRecipientsResponse257 = CMDAdapter.ResolveRecipients(resolveRecipientsRequest257);
        var status257 = int.Parse(resolveRecipientsResponse257.ResponseData.Status);
    ...
    {
        Site.Assume.AreNotEqual<string>("12.1", Common.GetConfigurationPropertyValue("ActiveSyncProtocolVersion", Site), "The MaxPictures element is not supported when the MS-ASProtocolVersion header is set to 12.1. MS-ASProtocolVersion header value is determined using Common PTFConfig property named ActiveSyncProtocolVersion.");
        Site.Assume.AreNotEqual<string>("14.0", Common.GetConfigurationPropertyValue("ActiveSyncProtocolVersion", Site), "The MaxPictures element is not supported when the MS-ASProtocolVersion header is set to 14.0. MS-ASProtocolVersion header value is determined using Common PTFConfig property named ActiveSyncProtocolVersion.");
    ...
    public void MSASCMD_S13_TC08_ResolveRecipients_AmbiguousUser()
    {
        ...
        var displayName = Common.GetConfigurationPropertyValue("AmbiguousSearchName", Site);
        var resolveRecipientsRequest = new ResolveRecipientsRequest
        {
            RequestData = new Request.ResolveRecipients
            {
        ...
        var isFullNameReturned = true;
        var isNullCertificates = true;
    ...
    {
        Site.Assume.AreNotEqual<string>("12.1", Common.GetConfigurationPropertyValue("ActiveSyncProtocolVersion", Site), "The Availability element is not supported when the MS-ASProtocolVersion header is set to 12.1. MS-ASProtocolVersion header value is determined using Common PTFConfig property named ActiveSyncProtocolVersion.");
    ...
    public void MSASCMD_S13_TC12_ResolveRecipients_To()
    {
        ...
        var recipientName = Common.GetConfigurationPropertyValue("User1Name", Site);
        var resolveRecipientsRequest = new ResolveRecipientsRequest
        {
            RequestData = new Request.ResolveRecipients
            {
    ...
    public void MSASCMD_S13_TC15_ResolveRecipients_MergedFreeBusyIntervalTime()
    {
        ...
        var resolveRecipientsResponseBeforeReceiveMeeting = CMDAdapter.ResolveRecipients(resolveRecipientsRequest);
        ...
        var meetingSubject = Common.GenerateResourceName(Site, "subject");
        ...
        {
            var createdCalendar = CreateCalendar(meetingSubject, attendeeEmailAddress, calendar);
            SendMeetingRequest(meetingSubject, createdCalendar);
        }
        else
        {
            calendar.OrganizerEmail = Common.GetMailAddress(User1Information.UserName, User1Information.UserDomain);
            calendar.OrganizerName = Common.GetMailAddress(User1Information.UserName, User1Information.UserDomain);
            ...
            SendMeetingRequest(meetingSubject, calendar);
        }
        #endregion
        ...
        // Sync Inbox folder
        GetMailItem(User2Information.InboxCollectionId, meetingSubject);

        // Sync Calendar folder
        GetMailItem(User2Information.CalendarCollectionId, meetingSubject);
        #endregion

        #region Record user name, folder collectionId and item subject that are generated in this case
        RecordCaseRelativeItems(User2Information, User2Information.InboxCollectionId, meetingSubject);
        RecordCaseRelativeItems(User2Information, User2Information.CalendarCollectionId, meetingSubject);
        #endregion

        #region Check user2's MergedFreeBusy status before sending meeting response
        var resolveRecipientsResponseBeforeMeetingResponse = CMDAdapter.ResolveRecipients(resolveRecipientsRequest);
        #endregion
    ...
    {
        Site.Assume.AreNotEqual<string>("12.1", Common.GetConfigurationPropertyValue("ActiveSyncProtocolVersion", Site), "The Picture element is not supported when the MS-ASProtocolVersion header is set to 12.1. MS-ASProtocolVersion header value is determined using Common PTFConfig property named ActiveSyncProtocolVersion.");
        Site.Assume.AreNotEqual<string>("14.0", Common.GetConfigurationPropertyValue("ActiveSyncProtocolVersion", Site), "The Picture element is not supported when the MS-ASProtocolVersion header is set to 14.0. MS-ASProtocolVersion header value is determined using Common PTFConfig property named ActiveSyncProtocolVersion.");
    ...
    public void MSASCMD_S13_TC20_ResolveRecipients_Status5()
    {
        ...
        if (Common.IsRequirementEnabled(7500, Site))
        {
            // Add the debug information
        ...
        if (Common.IsRequirementEnabled(7501, Site))
        {
            // Add the debug information
    ...
    public void MSASCMD_S13_TC21_ResolveRecipients_Status163()
    {
        ...
        var originalAccessRights = GetMailboxFolderPermission(Common.GetConfigurationPropertyValue("SutComputerName", Site), User3Information);
        ...
        SetMailboxFolderPermission(Common.GetConfigurationPropertyValue("SutComputerName", Site), User3Information, "None");
        var currentAccessRights = GetMailboxFolderPermission(Common.GetConfigurationPropertyValue("SutComputerName", Site), User3Information);
        ...
        if (originalAccessRights != currentAccessRights)
        {
            ...
            SetMailboxFolderPermission(Common.GetConfigurationPropertyValue("SutComputerName", Site), User3Information, originalAccessRights);
        }
    ...
    {
        var integer = length / 7;
        var remainder = length % 7;
        var createString = string.Empty;
