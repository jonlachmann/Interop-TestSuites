...
public class S07_GetItemEstimate : TestSuiteBase
{
    ...
    public void MSASCMD_S07_TC01_GetItemEstimate_Success()
    {
        ...
        Sync(CreateEmptySyncRequest(User2Information.InboxCollectionId), false);
    ...
    public void MSASCMD_S07_TC02_GetItemEstimate_WithoutOptions()
    {
        ...
        getItemEstimateRequest = CreateGetItemEstimateRequest(LastSyncKey, User1Information.InboxCollectionId, null);
        var getItemEstimateResponseNoOption = CMDAdapter.GetItemEstimate(getItemEstimateRequest);
    ...
    public void MSASCMD_S07_TC03_GetItemEstimate_Contacts_FilterType()
    {
        ...
        var getItemEstimateResponse = GetItemEstimateWithFilterType(User1Information.ContactsCollectionId, 0);
    ...
    public void MSASCMD_S07_TC04_GetItemEstimate_Email_FilterType()
    {
        ...
        Sync(CreateEmptySyncRequest(User2Information.InboxCollectionId));

        #region Call GetItemEstimate with FilterType setting to 0 to get estimate number of all items in Inbox folder.
        var getItemEstimateResponse = GetItemEstimateWithFilterType(User2Information.InboxCollectionId, 0);
        ...
        var original = Convert.ToInt32(getItemEstimateResponse.ResponseData.Response[0].Collection.Estimate);
        ...
        getItemEstimateResponse = CMDAdapter.GetItemEstimate(CreateGetItemEstimateRequest(LastSyncKey, User2Information.InboxCollectionId, null));
        Site.Assert.IsNotNull(getItemEstimateResponse.ResponseData.Response, "The response of GetItemEstimate command should not be null.");
        var current = Convert.ToInt32(getItemEstimateResponse.ResponseData.Response[0].Collection.Estimate);
        ...
        getItemEstimateResponse = GetItemEstimateWithFilterType(User2Information.InboxCollectionId, 1);
        Site.Assert.IsNotNull(getItemEstimateResponse.ResponseData.Response, "The response of GetItemEstimate command should not be null.");
        ...
        var anotherEmailSubject = Common.GenerateResourceName(Site, "subject");
        SendPlainTextEmail(null, anotherEmailSubject, User1Information.UserName, User2Information.UserName, null);

        SwitchUser(User2Information);
        CheckEmail(User2Information.InboxCollectionId, anotherEmailSubject, null);
        RecordCaseRelativeItems(User2Information, User2Information.InboxCollectionId, anotherEmailSubject);
        ...
        getItemEstimateResponse = GetItemEstimateWithFilterType(User2Information.InboxCollectionId, 2);
        Site.Assert.IsNotNull(getItemEstimateResponse.ResponseData.Response, "The response of GetItemEstimate command should not be null.");
        ...
        getItemEstimateResponse = GetItemEstimateWithFilterType(User2Information.InboxCollectionId, 3);
        Site.Assert.IsNotNull(getItemEstimateResponse.ResponseData.Response, "The response of GetItemEstimate command should not be null.");
        ...
        getItemEstimateResponse = GetItemEstimateWithFilterType(User2Information.InboxCollectionId, 4);
        Site.Assert.IsNotNull(getItemEstimateResponse.ResponseData.Response, "The response of GetItemEstimate command should not be null.");
        ...
        getItemEstimateResponse = GetItemEstimateWithFilterType(User2Information.InboxCollectionId, 5);
        Site.Assert.IsNotNull(getItemEstimateResponse.ResponseData.Response, "The response of GetItemEstimate command should not be null.");
        ...
        getItemEstimateResponse = GetItemEstimateWithFilterType(User2Information.InboxCollectionId, 6);
        ...
        getItemEstimateResponse = GetItemEstimateWithFilterType(User2Information.InboxCollectionId, 7);
        ...
        getItemEstimateResponse = GetItemEstimateWithFilterType(User2Information.InboxCollectionId, 8);
    ...
    public void MSASCMD_S07_TC05_GetItemEstimate_Calendar_FilterType()
    {
        ...
        var getItemEstimateResponse = GetItemEstimateWithFilterType(User1Information.CalendarCollectionId, (byte)0);
        Site.Assert.IsNotNull(getItemEstimateResponse.ResponseData.Response, "The response of GetItemEstimate command should not be null.");
        ...
        getItemEstimateResponse = GetItemEstimateWithFilterType(User1Information.CalendarCollectionId, (byte)1);
        ...
        getItemEstimateResponse = GetItemEstimateWithFilterType(User1Information.CalendarCollectionId, (byte)2);
        ...
        getItemEstimateResponse = GetItemEstimateWithFilterType(User1Information.CalendarCollectionId, (byte)3);
        ...
        getItemEstimateResponse = GetItemEstimateWithFilterType(User1Information.CalendarCollectionId, (byte)4);
        Site.Assert.IsNotNull(getItemEstimateResponse.ResponseData.Response, "The response of GetItemEstimate command should not be null.");
        ...
        var isVerifyR2971 = !string.IsNullOrEmpty(FindServerId(syncResponse, "Subject", calendarSubject));
        ...
        isVerifyR2971 = isVerifyR2971 && !string.IsNullOrEmpty(FindServerId(syncResponse, "Subject", calendarSubject));
        ...
        var isVerifyR5877 = !string.IsNullOrEmpty(FindServerId(syncResponse, "Subject", recurrenceCalendarSubject));
        ...
        isVerifyR5877 = isVerifyR5877 && !string.IsNullOrEmpty(FindServerId(syncResponse, "Subject", recurrenceCalendarSubject));
        ...
        getItemEstimateResponse = GetItemEstimateWithFilterType(User1Information.CalendarCollectionId, (byte)5);
        Site.Assert.IsNotNull(getItemEstimateResponse.ResponseData.Response, "The response of GetItemEstimate command should not be null.");
        ...
        getItemEstimateResponse = GetItemEstimateWithFilterType(User1Information.CalendarCollectionId, (byte)6);
        Site.Assert.IsNotNull(getItemEstimateResponse.ResponseData.Response, "The response of GetItemEstimate command should not be null.");
        ...
        getItemEstimateResponse = GetItemEstimateWithFilterType(User1Information.CalendarCollectionId, (byte)7);
        Site.Assert.IsNotNull(getItemEstimateResponse.ResponseData.Response, "The response of GetItemEstimate command should not be null.");
        ...
        getItemEstimateResponse = GetItemEstimateWithFilterType(User1Information.CalendarCollectionId, (byte)8);
    ...
    public void MSASCMD_S07_TC06_GetItemEstimate_Tasks_FilterType()
    {
        ...
        Sync(CreateEmptySyncRequest(User1Information.TasksCollectionId));

        #region Call GetItemEstimate with FilterType setting to 0 to get estimate number of all items in Tasks folder.
        var getItemEstimateResponse = GetItemEstimateWithFilterType(User1Information.TasksCollectionId, (byte)0);
        ...
        getItemEstimateResponse = GetItemEstimateWithFilterType(User1Information.TasksCollectionId, (byte)1);
        ...
        getItemEstimateResponse = GetItemEstimateWithFilterType(User1Information.TasksCollectionId, (byte)2);
        ...
        getItemEstimateResponse = GetItemEstimateWithFilterType(User1Information.TasksCollectionId, (byte)3);
        ...
        getItemEstimateResponse = GetItemEstimateWithFilterType(User1Information.TasksCollectionId, (byte)4);
        ...
        getItemEstimateResponse = GetItemEstimateWithFilterType(User1Information.TasksCollectionId, (byte)5);
        ...
        getItemEstimateResponse = GetItemEstimateWithFilterType(User1Information.TasksCollectionId, (byte)6);
        ...
        getItemEstimateResponse = GetItemEstimateWithFilterType(User1Information.TasksCollectionId, (byte)7);
        ...
        getItemEstimateResponse = GetItemEstimateWithFilterType(User1Information.TasksCollectionId, (byte)8);
        Site.Assert.IsNotNull(getItemEstimateResponse.ResponseData.Response, "The response of GetItemEstimate command should not be null.");
    ...
    public void MSASCMD_S07_TC07_GetItemEstimate_InvalidFilterType()
    {
        ...
        var getItemEstimateResponse = GetItemEstimateWithFilterType(User1Information.ContactsCollectionId, 9);
        var statusOfContacts = int.Parse(getItemEstimateResponse.ResponseData.Response[0].Status);
        ...
        GetInitialSyncResponse(User1Information.InboxCollectionId);
        getItemEstimateResponse = GetItemEstimateWithFilterType(User1Information.InboxCollectionId, 9);
        var statusOfInbox = int.Parse(getItemEstimateResponse.ResponseData.Response[0].Status);
        ...
        GetInitialSyncResponse(User1Information.CalendarCollectionId);
        getItemEstimateResponse = GetItemEstimateWithFilterType(User1Information.CalendarCollectionId, 9);
        var statusOfCalendar = int.Parse(getItemEstimateResponse.ResponseData.Response[0].Status);
        ...
        GetInitialSyncResponse(User1Information.TasksCollectionId);
        getItemEstimateResponse = GetItemEstimateWithFilterType(User1Information.TasksCollectionId, 9);
        var statusOfTasks = int.Parse(getItemEstimateResponse.ResponseData.Response[0].Status);
    ...
    public void MSASCMD_S07_TC08_GetItemEstimate_MoreThanOneMaxItems()
    {
        ...
        Sync(CreateEmptySyncRequest(User1Information.RecipientInformationCacheCollectionId));
    ...
    public void MSASCMD_S07_TC09_GetItemEstimate_Status2()
    {
        ...
        var getItemEstimateRequest = new GetItemEstimateRequest
        {
        ...
        var isVerifyR4130 = int.Parse(getItemEstimateResponse.ResponseData.Response[0].Status) == 1 && int.Parse(getItemEstimateResponse.ResponseData.Response[1].Status) != 1;
        Site.CaptureRequirementIfIsTrue(
            isVerifyR4130,
            4130,
    ...
    public void MSASCMD_S07_TC11_GetItemEstimate_Status4_InvalidSyncKey()
    {
        ...
        var invalidSyncKey = Common.GenerateResourceName(Site, "InvalidSyncKey");
    ...
    public void MSASCMD_S07_TC12_GetItemEstimate_Status4_MismatchedSyncKey()
    {
        ...
        Sync(CreateEmptySyncRequest(User1Information.ContactsCollectionId));
        var unmatchedSyncKey = LastSyncKey;
    ...
    public void MSASCMD_S07_TC13_GetItemEstimate_ConversationMode_Status103()
    {
        ...
        var getItemEstimateRequest = CreateGetItemEstimateRequest(LastSyncKey, User1Information.ContactsCollectionId, null, true);
    ...
    public void MSASCMD_S07_TC15_GetItemEstimate_Collection_LimitValue()
    {
        ...
        var getItemEstimateRequest = Common.CreateGetItemEstimateRequest(collections.ToArray());
        var getItemEstimateResponse = CMDAdapter.GetItemEstimate(getItemEstimateRequest);
