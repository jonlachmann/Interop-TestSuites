...
public class S10_MoveItems : TestSuiteBase
{
    ...
    public void MSASCMD_S10_TC01_MoveItems_Success()
    {
        ...
        SyncChanges(User1Information.DeletedItemsCollectionId);
        var syncKeyDeletedItems = LastSyncKey;
        #endregion
        ...
        var moveItemsRequest = CreateMoveItemsRequest(serverId, User1Information.InboxCollectionId, User1Information.DeletedItemsCollectionId);
        var moveItemsResponse = CMDAdapter.MoveItems(moveItemsRequest);

        CheckMoveItemsResponse(moveItemsResponse, 1);
        ...
        var isItemDeleted = CheckDeleteInSyncResponse(syncKeyInbox, User1Information.InboxCollectionId, serverId);
        Site.Assert.IsTrue(isItemDeleted, "The item with ServerId: {0} should be deleted for collection ID: {0}.", serverId, User1Information.InboxCollectionId);
        RemoveRecordCaseRelativeItems(User1Information, User1Information.InboxCollectionId, subject);

        var isItemAdded = CheckAddInSyncResponse(syncKeyDeletedItems, User1Information.DeletedItemsCollectionId, subject);
    ...
    public void MSASCMD_S10_TC02_MoveItems_Status1_InvalidSrcFldId()
    {
        ...
        var moveItemsRequest = CreateMoveItemsRequest(serverId, "Invalid SrcFldId", User1Information.DeletedItemsCollectionId);
        var moveItemsResponse = CMDAdapter.MoveItems(moveItemsRequest);
    ...
    public void MSASCMD_S10_TC03_MoveItems_Status1_InvalidSrcMsgId()
    {
        ...
        moveItemsRequest = CreateMoveItemsRequest(serverId, User1Information.InboxCollectionId, User1Information.DeletedItemsCollectionId);
        moveItemsResponse = CMDAdapter.MoveItems(moveItemsRequest);
    ...
    public void MSASCMD_S10_TC04_MoveItems_Status2()
    {
        ...
        var moveItemsRequest = CreateMoveItemsRequest(serverId, User1Information.InboxCollectionId, "Invalid DstFldId");
        var moveItemsResponse = CMDAdapter.MoveItems(moveItemsRequest);
    ...
    public void MSASCMD_S10_TC05_MoveItems_Status4()
    {
        ...
        var moveItemsRequest = CreateMoveItemsRequest(serverId, User1Information.InboxCollectionId, User1Information.InboxCollectionId);
        var moveItemsResponse = CMDAdapter.MoveItems(moveItemsRequest);
    ...
    public void MSASCMD_S10_TC06_MoveItems_Status5()
    {
        ...
        SyncChanges(User1Information.SentItemsCollectionId);
        var syncKeySentItems = LastSyncKey;
        #endregion
        ...
        var moveItemsRequest = new MoveItemsRequest();
        var moveItems = new Request.MoveItems();
        var moveItemList = new List<Request.MoveItemsMove>();

        var moveItemsMoveOne = new Request.MoveItemsMove
        {
        ...
        var moveItemsMoveTwo = new Request.MoveItemsMove
        {
            DstFldId = User1Information.SentItemsCollectionId,
            SrcFldId = User1Information.InboxCollectionId,
            SrcMsgId = serverId
        };
        ...
        CheckMoveItemsResponse(moveItemsResponse, 2);

        var hasStatus5 = false;
        var hasStatus3 = false;
        ...
        {
            var isItemDeleted = CheckDeleteInSyncResponse(syncKeyInbox, User1Information.InboxCollectionId, serverId);
            Site.Assert.IsTrue(isItemDeleted, "The item with ServerId: {0} should be deleted for collection ID: {1}.", serverId, User1Information.InboxCollectionId);
            RemoveRecordCaseRelativeItems(User1Information, User1Information.InboxCollectionId, subject);

            var isItemAddedDeleteItems = CheckAddInSyncResponse(syncKeyDeletedItems, User1Information.DeletedItemsCollectionId, subject);
            ...
            var isItemAddedSentItems = CheckAddInSyncResponse(syncKeySentItems, User1Information.SentItemsCollectionId, subject);
            if (isItemAddedSentItems)
            {
                ...
                RecordCaseRelativeItems(User1Information, User1Information.SentItemsCollectionId, subject);
            }
    ...
    {
        Site.Assume.IsTrue(Common.IsRequirementEnabled(5671, Site), "Exchange 2007 does not limit the number of elements in command requests.");
        ...
        var requestData = moveItems;
        request.RequestData = requestData;

        var moveItemsResponse = CMDAdapter.MoveItems(request);
    ...
    private void CheckMoveItemsResponse(MoveItemsResponse moveItemsResponse, int expectedResponseNumber)
    {
        ...
        for (var i = 0; i < expectedResponseNumber; i++)
        {
    ...
    private Response.SyncCollectionsCollectionCommands GetCommandsFromSyncResponse(SyncResponse syncResponse)
    {
        ...
        for (var i = 0; i < syncCollections.Collection[0].ItemsElementName.Length; i++)
        {
    ...
    {
        var syncResponse = SyncChanges(syncKey, collectionId);
        var commands = GetCommandsFromSyncResponse(syncResponse);
    ...
    {
        var syncResponse = syncKey != null
            ? SyncChanges(syncKey, collectionId)
            : SyncChanges(collectionId);
        ...
        foreach (var add in commands.Add)
        {
            ...
            for (var i = 0; i < add.ApplicationData.Items.Length; i++)
            {
