...
public class S03_FolderDelete : TestSuiteBase
{
    ...
    public void MSASCMD_S03_TC01_FolderDelete_Success()
    {
        ...
        var folderCreateResponse = GetFolderCreateResponse(LastFolderSyncKey, (byte)FolderType.UserCreatedMail, Common.GenerateResourceName(Site, "FolderDelete"), "0");
        ...
        var folderDeleteRequest = Common.CreateFolderDeleteRequest(folderCreateResponse.ResponseData.SyncKey, folderCreateResponse.ResponseData.ServerId);
    ...
    public void MSASCMD_S03_TC02_FolderDelete_Status3()
    {
        ...
        var folderDeleteRequest = Common.CreateFolderDeleteRequest(LastFolderSyncKey, User1Information.CalendarCollectionId);
        var folderDeleteResponse = CMDAdapter.FolderDelete(folderDeleteRequest);
        ...
        if ("12.1" != Common.GetConfigurationPropertyValue("ActiveSyncProtocolVersion", Site))
        {
            ...
            folderDeleteRequest = Common.CreateFolderDeleteRequest(LastFolderSyncKey, "RI");
            folderDeleteResponse = CMDAdapter.FolderDelete(folderDeleteRequest);
    ...
    public void MSASCMD_S03_TC03_FolderDelete_Status4()
    {
        ...
        var folderDeleteRequest = Common.CreateFolderDeleteRequest(LastFolderSyncKey, "InvalidServerId");
        var folderDeleteResponse = CMDAdapter.FolderDelete(folderDeleteRequest);
    ...
    public void MSASCMD_S03_TC04_FolderDelete_Status9()
    {
        ...
        var folderDeleteRequest = Common.CreateFolderDeleteRequest(string.Empty, folderCreateResponse.ResponseData.ServerId);
        var folderDeleteResponse = CMDAdapter.FolderDelete(folderDeleteRequest);
    ...
    public void MSASCMD_S03_TC05_FolderDelete_Status10()
    {
        ...
        var folderDeleteRequest = Common.CreateFolderDeleteRequest(null, folderCreateResponse.ResponseData.ServerId);
        var folderDeleteResponse = CMDAdapter.FolderDelete(folderDeleteRequest);
