...
public class S05_SmartReply : TestSuiteBase
{
    ...
    public void MSASRM_S05_TC01_SmartReply_EditAllowed_False_NoReplaceMime()
    {
        ...
        var templateID = GetTemplateID("MSASRM_EditExport_NotAllowedTemplate");
        #endregion
        ...
        var replyRequest = TestSuiteHelper.CreateSmartReplyRequest(UserTwoInformation.InboxCollectionId, item.ServerId, replyMime);
        replyRequest.RequestData.TemplateID = templateID;
        var smartReplyResponse = ASRMAdapter.SmartReply(replyRequest);
        ...
        AddCreatedItemToCollection(UserOneInformation, UserOneInformation.InboxCollectionId, replySubject);
        #endregion
        ...
        item = SyncEmail(replySubject, UserOneInformation.InboxCollectionId, true, true);
        Site.Assert.IsNotNull(item, "The returned item should not be null.");
    ...
    public void MSASRM_S05_TC03_SmartReply_ExportAllowed_True()
    {
        ...
        var repliedItem = SyncEmail(replySubject, UserOneInformation.InboxCollectionId, true, true);
...
 The TemplateID on the new message is set to the ""No Restriction"" template (TemplateID value ""00000000-0000-0000-0000-000000000000"")]The original message retains its IRM protection.");
    ...
    public void MSASRM_S05_TC04_SmartReplyAll_ExportAllowed_True()
    {
        ...
        var subject = SendMailAndFolderSync(templateID, false, UserThreeInformation);
        #endregion
        ...
        AddCreatedItemToCollection(UserThreeInformation, UserThreeInformation.InboxCollectionId, replySubject);
        SwitchUser(UserOneInformation, false);
        AddCreatedItemToCollection(UserOneInformation, UserOneInformation.InboxCollectionId, replySubject);
        #endregion
        ...
        item = SyncEmail(replySubject, UserThreeInformation.InboxCollectionId, true, true);
    ...
    public void MSASRM_S05_TC05_SmartReply_ReplyAllowed_True_ReplyAllAllowed_False_Status172()
    {
        ...
        var templateID = GetTemplateID("MSASRM_ViewReply_AllowedTemplate");
        #endregion
        ...
        item = SyncEmail(replySubject, UserOneInformation.InboxCollectionId, true, false);
        ...
        // Get the new added email item
        item = SyncEmail(replySubject, UserThreeInformation.InboxCollectionId, true, false);
        Site.Assert.IsNull(item, "The returned item should be null.");
        #endregion
    ...
    public void MSASRM_S05_TC06_SmartReply_ReplyAllowed_False_ReplyAllAllowed_True_Status172()
    {
        ...
        var templateID = GetTemplateID("MSASRM_ViewReplyAll_AllowedTemplate");
        #endregion
    ...
    public void MSASRM_S05_TC07_SmartReply_ModifyRecipientsAllowed_False()
    {
        ...
        var templateID = GetTemplateID("MSASRM_View_AllowedTemplate");
        #endregion
    ...
    public void MSASRM_S05_TC13_SmartReply_NotProtected_OriginalMessage_NotProtected()
    {
        ...
        var subject = SendMailAndFolderSync(null, false, null);
        #endregion
...
If the original message being replied to has no rights management restrictions, the server proceeds to step 6[The server sends the new message].");
    ...
    {
        Site.Assume.AreEqual<string>("14.1", Common.GetConfigurationPropertyValue("ActiveSyncProtocolVersion", Site), "Implementation does consider the XML body of the command request to be invalid, if the protocol version specified by in the command request is not 14.1.");
        Site.Assume.AreEqual<string>("HTTP", Common.GetConfigurationPropertyValue("TransportType", Site).ToUpper(CultureInfo.CurrentCulture), "This test case is designed to run under HTTP");
        ...
        var item = SyncEmail(subject, UserTwoInformation.InboxCollectionId, false, true);
        Site.Assert.IsNotNull(item, "The returned item should not be null.");
        Site.Assert.IsNull(item.Email.RightsManagementLicense, "The RightsManagementLicense element in expected rights-managed e-mail message should be null.");
        #endregion
    ...
    public void MSASRM_S05_TC16_SmartReply_Protected_OriginalMessage_Protected_DifferentTemplate()
    {
        ...
        templateID = GetTemplateID("MSASRM_EditExport_NotAllowedTemplate");
        #endregion
    ...
    public void MSASRM_S05_TC18_SmartReply_Export_True_Edit_True_ReplaceMime_DifferentTemplate()
    {
        ...
        #region The client logs on User2's account, calls Settings command to get another templateID with reply rights allowed.
        templateID = GetTemplateID("MSASRMReplyAll_NotAllowedTemplate");
        #endregion
    ...
    public void MSASRM_S05_TC19_SmartReply_Export_False_Edit_True_ReplaceMime_SameTemplate()
    {
        ...
        var templateID = GetTemplateID("MSASRM_Export_NotAllowedTemplate");
        #endregion
    ...
    public void MSASRM_S05_TC22_SmartReply_Export_True_Edit_True_NoReplaceMime_SameTemplate()
    {
        ...
        var originalContent = item.Email.Body.Data;
        #endregion
        ...
        Site.Assert.IsNotNull(item.Email.Body, "The Body element in expected rights-managed e-mail message should not be null.");
        Site.Assert.IsNotNull(item.Email.Body.Data, "The Data element in expected rights-managed e-mail message should not be null.");
        var repliedContent = item.Email.Body.Data;
