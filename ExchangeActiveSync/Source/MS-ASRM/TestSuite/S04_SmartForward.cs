...
public class S04_SmartForward : TestSuiteBase
{
    ...
    public void MSASRM_S04_TC01_SmartForward_EditAllowed_False_NoReplaceMime()
    {
        ...
        var forwardRequest = TestSuiteHelper.CreateSmartForwardRequest(UserTwoInformation.InboxCollectionId, item.ServerId, forwardMime);
        forwardRequest.RequestData.TemplateID = templateID;
        var smartForwardResponse = ASRMAdapter.SmartForward(forwardRequest);
        ...
        AddCreatedItemToCollection(UserThreeInformation, UserThreeInformation.InboxCollectionId, forwardSubject);
        item = SyncEmail(forwardSubject, UserThreeInformation.InboxCollectionId, true, true);
        Site.Assert.IsNotNull(item, "The returned item should not be null.");
    ...
    public void MSASRM_S04_TC03_SmartForward_ExportAllowed_True()
    {
        ...
        SwitchUser(UserThreeInformation, true);
        AddCreatedItemToCollection(UserThreeInformation, UserThreeInformation.InboxCollectionId, forwardSubject);
        var forwardItem = SyncEmail(forwardSubject, UserThreeInformation.InboxCollectionId, true, true);
...
 The TemplateID on the new message is set to the ""No Restriction"" template (TemplateID value ""00000000-0000-0000-0000-000000000000"").");
    ...
    public void MSASRM_S04_TC04_SmartForward_ForwardAllowed_False()
    {
        ...
        SwitchUser(UserThreeInformation, true);
        item = SyncEmail(forwardSubject, UserThreeInformation.InboxCollectionId, true, false);
