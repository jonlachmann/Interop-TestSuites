...
public partial class MS_ASRMAdapter
{
    ...
    private void VerifyRightsManagementLicense(Response.RightsManagementLicense rightsManagementLicense)
    {
        ...
        VerifyNonEmptyString(rightsManagementLicense.ContentOwner);
        ...
        VerifyNonEmptyString(rightsManagementLicense.TemplateDescription);
        ...
        VerifyNonEmptyString(rightsManagementLicense.TemplateID);
        ...
        VerifyNonEmptyString(rightsManagementLicense.TemplateName);
    ...
    private void VerifySettingsResponse(SettingsResponse settingsResponse)
    {
        ...
        if (settingsResponse.ResponseData.RightsManagementInformation != null)
        {
            ...
            {
                VerifyRightsManagementTemplates(settingsResponse.ResponseData.RightsManagementInformation.Get);
            }
        }
    }
    ...
    private void VerifyRightsManagementTemplates(Response.SettingsRightsManagementInformationGet rightsManagementTemplatesResponse)
    {
        ...
        var lengthOfArray = rightsManagementTemplatesResponse.RightsManagementTemplates.Length;
        ...
        {
            VerifyRightsManagementTemplate(rightsManagementTemplatesResponse.RightsManagementTemplates[i]);
        }
    }
    #endregion
    ...
    private void VerifySyncResponse(Sync sync)
    {
        if (sync != null)
        {
            ...
            if (sync.Email.RightsManagementLicense != null)
            {
                ...
                VerifyRightsManagementLicense(sync.Email.RightsManagementLicense);
            }
        }
    }
    #endregion
    ...
    {
        foreach (var itemOperations in itemOperationsStore.Items)
        {
            if (itemOperations.Email != null)
            {
                if (itemOperations.Email.RightsManagementLicense != null)
                {
                    ...
                    VerifyRightsManagementLicense(itemOperations.Email.RightsManagementLicense);
                }
            }
        }
    }
    ...
    {
        foreach (var search in searchStore.Results)
        {
            if (search.Email != null)
            {
                if (search.Email.RightsManagementLicense != null)
                {
                    ...
                    VerifyRightsManagementLicense(search.Email.RightsManagementLicense);
                }
            }
        }
    }
        ...
        if (decodedData != null)
        {
            ...
            foreach (var decodeDataItem in decodedData)
            {
                ...
                if (24 == codepage)
                {
                    ...
                    VerifyRequirementsRelateToCodePage24(codepage, tagName, token);
                }
            }
        }
    }
