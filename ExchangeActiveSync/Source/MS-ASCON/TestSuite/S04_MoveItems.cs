...
public class S04_MoveItems : TestSuiteBase
{
    ...
    public void MSASCON_S04_TC01_MoveItems_Move()
    {
        ...
        var moveItemsResponse = CallMoveItemsCommand(sourceConversationItem.ServerId, User1Information.InboxCollectionId, User1Information.SentItemsCollectionId);
        ...
        var destinationCoversationItem = GetConversationItem(User1Information.SentItemsCollectionId, sourceConversationItem.ConversationId);
        ...
        var allEmailsMoved = syncResult == null && sourceConversationItem.ServerId.Count == destinationCoversationItem.ServerId.Count;
