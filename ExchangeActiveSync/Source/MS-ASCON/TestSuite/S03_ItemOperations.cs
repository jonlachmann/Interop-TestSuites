...
public class S03_ItemOperations : TestSuiteBase
{
    ...
    public void MSASCON_S03_TC01_ItemOperations_Ignore()
    {
        ...
        var itemOperationResponse = ItemOperationsMove(sourceConversationItem.ConversationId, User1Information.DeletedItemsCollectionId, true);
        ...
        var isVerifiedR214 = itemOperationResponse.ResponseData.Response.Move[0].Status != null && itemOperationResponse.ResponseData.Response.Move[0].ConversationId != null;
        ...
        var syncResult = SyncEmail(conversationSubject, User1Information.InboxCollectionId, false, null, null);
        Site.Assert.IsNull(syncResult, "No conversation messages should not be found in Inbox folder.");

        var destinationCoversationItem = GetConversationItem(User1Information.DeletedItemsCollectionId, sourceConversationItem.ConversationId);
        ...
        destinationCoversationItem = GetConversationItem(User1Information.DeletedItemsCollectionId, sourceConversationItem.ConversationId, sourceConversationItem.ServerId.Count + 1);
        ...
        syncResult = SyncEmail(conversationSubject, User1Information.InboxCollectionId, false, null, null);
    ...
    public void MSASCON_S03_TC02_ItemOperations_MoveAlways()
    {
        ...
        var idToMove = new Collection<string>();
        idToMove.Add(sourceConversationItem.ServerId[0]);
        CallMoveItemsCommand(idToMove, User1Information.InboxCollectionId, User1Information.SentItemsCollectionId);
        #endregion
    ...
    public void MSASCON_S03_TC03_ItemOperations_Status2()
    {
        ...
        var move = new ItemOperationsMove
        {
    ...
    public void MSASCON_S03_TC04_ItemOperations_Status6()
    {
        ...
        var conversationId = Convert.ToBase64String(Encoding.Default.GetBytes("NotExistConversationId"));
        var itemOperationResponse = ItemOperationsMove(conversationId, User1Information.SentItemsCollectionId, true);
        ...
        itemOperationResponse = ItemOperationsMove(conversationItem.ConversationId, "NotExistFolderId", true);
    ...
    public void MSASCON_S03_TC05_ItemOperations_Status105()
    {
        ...
        var itemOperationResponse = ItemOperationsMove(conversationItem.ConversationId, User1Information.RecipientInformationCacheCollectionId, true);
    ...
    public void MSASCON_S03_TC06_ItemOperations_Status156()
    {
        ...
        var itemOperationResponse = ItemOperationsMove(conversationItem.ConversationId, User1Information.CalendarCollectionId, true);
    ...
    public void MSASCON_S03_TC07_ItemOperations_Status164()
    {
        ...
        var itemOperationsRequest = TestSuiteHelper.GetItemOperationsRequest(User1Information.InboxCollectionId, syncItem.ServerId, bodyPartPreference, null);
        ...
        VerifyMessagePartStatus164(byte.Parse(itemOperationsResponse.ResponseData.Response.Fetch[0].Status));
        #endregion
    }
    #endregion
    ...
    public void MSASCON_S03_TC08_ItemOperations_MessagePart()
    {
        ...
        var email = ItemOperationsFetch(User1Information.InboxCollectionId, syncItem.ServerId, null, null);
        VerifyMessagePartWithoutPreference(email);
        ...
        email = ItemOperationsFetch(User1Information.InboxCollectionId, syncItem.ServerId, null, bodyPreference);
        VerifyMessagePartWithBodyPreference(email);
        #endregion
        ...
        email = ItemOperationsFetch(User1Information.InboxCollectionId, syncItem.ServerId, bodyPartPreference, null);
        ...
        VerifyMessagePartWithBodyPartPreference(email, truncatedData, allData, (int)bodyPartPreference.TruncationSize);
        ...
        email = ItemOperationsFetch(User1Information.InboxCollectionId, syncItem.ServerId, bodyPartPreference, bodyPreference);
        VerifyMessagePartWithBothPreference(email);
        #endregion
    }
    #endregion
}