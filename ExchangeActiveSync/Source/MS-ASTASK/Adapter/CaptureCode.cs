...
public partial class MS_ASTASKAdapter
{
    ...
    {
        Site.Assert.IsTrue(activeSyncClient.ValidationResult, "The schema should be validated.");
        ...
        if (null != syncResponse.AddElements)
        {
            ...
            {
                var task = syncResponse.AddElements[i].Task;
                ...
                if (null != task)
                {
                    ...
                    VerifyUnsignedByteDataType(task.Complete);
                    ...
                    if (null != task.Importance)
                    {
                        ...
                        VerifyUnsignedByteDataType(task.Importance);
                    }
                    ...
                    if (null != task.Recurrence)
                    {
                        ...
                        VerifyUnsignedByteDataType(task.Recurrence.CalendarType);
                        ...
                        if (task.Recurrence.DayOfMonthSpecified)
                        {
                            ...
                            VerifyUnsignedByteDataType(task.Recurrence.DayOfMonth);
                        }
                        ...
                        if (task.Recurrence.DayOfWeekSpecified)
                        {
                            ...
                            VerifyUnsignedByteDataType(task.Recurrence.DayOfWeek);
                        }
                        ...
                        if (task.Recurrence.DeadOccurSpecified)
                        {
                            ...
                            VerifyUnsignedByteDataType(task.Recurrence.DeadOccur);
                        }
                        ...
                        if (task.Recurrence.FirstDayOfWeekSpecified)
                        {
                            ...
                            VerifyUnsignedByteDataType(task.Recurrence.FirstDayOfWeek);
                        }
                        ...
                        if (task.Recurrence.IsLeapMonthSpecified)
                        {
                            ...
                            VerifyUnsignedByteDataType(task.Recurrence.IsLeapMonth);
                        }
                        ...
                        if (task.Recurrence.MonthOfYearSpecified)
                        {
                            ...
                            VerifyUnsignedByteDataType(task.Recurrence.MonthOfYear);
                        }
                        ...
                        if (task.Recurrence.OccurrencesSpecified)
                        {
                            ...
                            VerifyUnsignedByteDataType(task.Recurrence.Occurrences);
                        }
                        ...
                        if (task.Recurrence.RegenerateSpecified)
                        {
                            ...
                            VerifyUnsignedByteDataType(task.Recurrence.Regenerate);
                        }
                        ...
                        if (task.Recurrence.WeekOfMonthSpecified)
                        {
                            ...
                            VerifyUnsignedByteDataType(task.Recurrence.WeekOfMonth);
                        }
                    ...
                    if (null != task.ReminderSet)
                    {
                        ...
                        VerifyUnsignedByteDataType(task.ReminderSet);
                    }
                    ...
                    if (null != task.Sensitivity)
                    {
                        ...
                        VerifyUnsignedByteDataType(task.Sensitivity);
                    }
