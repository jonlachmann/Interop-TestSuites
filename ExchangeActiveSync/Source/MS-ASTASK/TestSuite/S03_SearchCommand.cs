...
public class S03_SearchCommand : TestSuiteBase
{
    ...
    public void MSASTASK_S03_TC01_RetrieveTaskItemWithSearch()
    {
        ...
        var option = new Request.Options1();
        var items = new Dictionary<Request.ItemsChoiceType6, object>
        {
            {
        ...
        // Search the task
        var searchResponse = TASKAdapter.Search(searchRequest);
    ...
    public void MSASTASK_S03_TC02_RetrieveInvalidTaskItemWithSearch()
    {
        ...
        var sendStringResponse = TASKAdapter.SendStringRequest("<Search xmlns=\"Search\"><Store><Name>Mailbox</Name><Query><And><Class xmlns=\"AirSync\">Tasks</Class><CollectionId xmlns=\"AirSync\">" + UserInformation.TasksCollectionId + "</CollectionId><FreeText>FreeText</FreeText><Subject xmlns=\"Tasks\">user</Subject></And></Query><Options><DeepTraversal /></Options></Store></Search>", CommandName.Search);
        ...
        while (counter < retryCount && searchStatus != null && searchStatus.InnerXml.Equals("10"))
        {
            ...
            sendStringResponse = TASKAdapter.SendStringRequest("<Search xmlns=\"Search\"><Store><Name>Mailbox</Name><Query><And><Class xmlns=\"AirSync\">Tasks</Class><CollectionId xmlns=\"AirSync\">" + UserInformation.TasksCollectionId + "</CollectionId><FreeText>FreeText</FreeText><Subject xmlns=\"Tasks\">user</Subject></And></Query><Options><DeepTraversal /></Options></Store></Search>", CommandName.Search);
            doc.LoadXml(sendStringResponse.ResponseDataXML);
