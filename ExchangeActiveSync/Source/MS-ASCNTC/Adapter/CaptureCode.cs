...
 WeightedRank (section 2.2.2.62)");
        ...
        if (syncStore.AddElements.Count != 0)
        {
            foreach (var item in syncStore.AddElements)
            {
                ...
                VerifyContactClassElements(item.Contact);
            }
        }
    ...
    private void VerifyItemOperationsResponse(ItemOperationsStore itemOperationsStore)
    {
        ...
        foreach (var itemOperations in itemOperationsStore.Items)
        {
            ...
            {
                VerifyContactClassElements(itemOperations.Contact);
            }
        }
    ...
    private void VerifySearchResponse(SearchStore searchStore)
    {
        ...
        foreach (var search in searchStore.Results)
        {
            ...
            {
                VerifyContactClassElements(search.Contact);
            }
        }
    ...
    private void VerifyContactClassElements(Contact contact)
    {
        ...
        if (contact.Anniversary != null)
        {
            ...
            VerifyDateTime(contact.Anniversary);
        }
        ...
        if (contact.Birthday != null)
        {
            ...
            VerifyDateTime(contact.Birthday);
        }
        ...
        if (contact.Categories != null)
        {
            ...
            VerifyContainer();
            VerifyCategory(contact.Categories.Category);
        }
        ...
        if (contact.Children != null)
        {
            ...
            VerifyContainer();
            VerifyChild(contact.Children.Child);
        }
        ...
        if (contact.Email1Address != null)
        {
            ...
            VerifyString();
            VerifyEmailAddress(contact.Email1Address);
        }
        ...
        if (contact.Email2Address != null)
        {
            ...
            VerifyString();
            VerifyEmailAddress(contact.Email2Address);
        }
        ...
        if (contact.Email3Address != null)
        {
            ...
            VerifyString();
            VerifyEmailAddress(contact.Email3Address);
        }
        ...
        {
            if (Common.IsRequirementEnabled(506, Site))
            {
                // Add the debug information
        ...
        if (decodedData != null)
        {
            ...
            foreach (var decodeDataItem in decodedData)
            {
                ...
                if (1 == codepage)
                {
                    ...
                    VerifyRequirementsRelateToCodePage1(codepage, tagName, token);
                }
                ...
                if (12 == codepage)
                {
                    ...
                    VerifyRequirementsRelateToCodePage12(codepage, tagName, token);
                }
            }
        }
    }
