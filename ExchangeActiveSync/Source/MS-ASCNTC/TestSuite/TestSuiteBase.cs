...
public class TestSuiteBase : TestClassBase
{
    ...
    {
        base.TestInitialize();
        if (ASCNTCAdapter == null)
        {
            ASCNTCAdapter = Site.GetAdapter<IMS_ASCNTCAdapter>();
        }
    ...
    {
        ASCNTCAdapter.SwitchUser(userInformation.UserName, userInformation.UserPassword, userInformation.UserDomain);
        ...
        if (isFolderSyncNeeded)
        {
            ...
            if (userInformation.UserName == User1Information.UserName)
            {
                ...
                if (string.IsNullOrEmpty(User1Information.ContactsCollectionId))
                {
                    User1Information.ContactsCollectionId = Common.GetDefaultFolderServerId(folderSyncResponse, FolderType.Contacts, Site);
                }
        ...
        var request = new SendMailRequest
        {
            RequestData =
            {
                ...
                Mime = TestSuiteHelper.CreateMIME(
                    ...
                    Common.GetMailAddress(Common.GetConfigurationPropertyValue("User2Name", Site), Common.GetConfigurationPropertyValue("Domain", Site)),
                    subject,
                    body)
            }
        };

        var sendMailResponse = ASCNTCAdapter.SendMail(request);
    ...
    protected string GetInitialSyncKey(string collectionId, Request.Supported supportedElements)
    {
        ...
        var syncRequest = TestSuiteHelper.CreateInitialSyncRequest(collectionId, supportedElements);
        var syncResult = ASCNTCAdapter.Sync(syncRequest);
        ...
        while (syncResult.Status == 12)
        {
            ...
            syncResult = ASCNTCAdapter.Sync(syncRequest);
        }
    ...
    protected DataStructures.Sync GetSyncAddResult(string subject, string collectionId, Request.BodyPreference bodyPreference, Request.Supported supported)
    {
        ...
        var request = TestSuiteHelper.CreateSyncRequest(GetInitialSyncKey(collectionId, supported), collectionId, bodyPreference);
        ...
        do
        {
            ...
            syncStore = ASCNTCAdapter.Sync(request);
        ...
        Site.Assert.IsNotNull(item, "The email item with subject {0} should be found, retry count: {1}.", subject, counter);

        SyncKey = syncStore.SyncKey;
    ...
    protected DataStructures.Sync GetSyncChangeResult(string fileAs, string collectionId, string syncKey, Request.BodyPreference bodyPreference)
    {
        DataStructures.SyncStore syncStore;
        DataStructures.Sync item = null;
        var request = TestSuiteHelper.CreateSyncRequest(syncKey, collectionId, bodyPreference);
        ...
        Site.Assert.IsNotNull(item, "The email item with FileAs: {0} should be found.", fileAs);
    ...
    protected DataStructures.ItemOperations GetItemOperationsResult(string collectionId, string serverId, Request.BodyPreference bodyPreference, Request.Schema schema)
    {
        ...
        var request = TestSuiteHelper.CreateItemOperationsRequest(collectionId, serverId, bodyPreference, schema);
        ...
        {
            Thread.Sleep(waitTime);
            itemOperationsStore = ASCNTCAdapter.ItemOperations(request, DeliveryMethodForFetch.Inline);
        ...
        Site.Assert.IsNotNull(item, "The item should be found, retry count: {0}.", counter);
    ...
    {
        var request = TestSuiteHelper.CreateSearchRequest(fileAs.Substring(0, fileAs.IndexOf('_')), collectionId, bodyPreference);

        var searchStore = ASCNTCAdapter.Search(request);
        ...
        Site.Assert.IsNotNull(searchItem, "The contact item with FileAs: {0} should be found.", fileAs);
    ...
    {
        var contactBody = new Request.Body { Type = 1, Data = Common.GenerateResourceName(Site, "Body") };
        var categories = new List<string> { Site.DefaultProtocolDocShortName + "Category" };
        var contactCategories = new Request.Categories1 { Category = categories.ToArray() };
        var children = new List<string> { Common.GenerateResourceName(Site, "Child") };
        var contactChildren = new Request.Children { Child = children.ToArray() };

        var contactProperties = new Dictionary<Request.ItemsChoiceType8, object>
        {
            {
                Request.ItemsChoiceType8.FileAs, Common.GenerateResourceName(Site, "Contact")
            },
            {
    ...
    protected DataStructures.SyncStore AddContact(string collectionId, Dictionary<Request.ItemsChoiceType8, object> contactProperties)
    {
        ...
        var syncKey = GetInitialSyncKey(collectionId, null);
        var syncAddRequest = TestSuiteHelper.CreateSyncAddRequest(syncKey, collectionId, applicationData);

        var syncAddStore = ASCNTCAdapter.Sync(syncAddRequest);
        Site.Assert.AreEqual<byte>(
            1,
    ...
    {
        var syncChangeRequest = TestSuiteHelper.CreateSyncChangeRequest(syncKey, collectionId, changeData);
        var changeStore = ASCNTCAdapter.Sync(syncChangeRequest);
    ...
    protected void RecordCaseRelativeItems(string userName, string folderCollectionId, params string[] itemSubjects)
    {
        ...
        if (userName == User2Information.UserName)
        {
    ...
    protected void VerifyContactClassElements(Dictionary<Request.ItemsChoiceType8, object> contactProperties, DataStructures.Contact contact)
    {
        ...
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R97");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R107");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R112");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R117");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R122");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R1120");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R130");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R135");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R140");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R143");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R148");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R153");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R158");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R163");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R168");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R1030");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R10040");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R190");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R195");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R200");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R205");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R209");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R214");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R221");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R226");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R231");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R238");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R243");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R248");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R253");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R258");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R263");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R268");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R273");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R278");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R283");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R288");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R293");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R298");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R303");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R308");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R313");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R318");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R323");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R328");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R333");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R338");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R343");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R348");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R353");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R358");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R363");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R368");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R373");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R1021");
        ...
        try
        {
            var pictureByte = Convert.FromBase64String(contact.Picture);

            // Add the debug information
            Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R381");
        ...
        {
            Site.Assert.Fail("The Picture element should be encoded with base64 encoding.");
        }

        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R385");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R390");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R395");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R400");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R405");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R417");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R422");
        ...
        // Add the debug information
        Site.Log.Add(LogEntryKind.Debug, "Verify MS-ASCNTC_R427");
    ...
    {
        var folderSyncResponse = ASCNTCAdapter.FolderSync(Common.CreateFolderSyncRequest("0"));
    ...
    {
        foreach (var createdItems in createdItemsCollection)
        {
            var syncKey = GetInitialSyncKey(createdItems.CollectionId, null);
            var request = TestSuiteHelper.CreateSyncRequest(syncKey, createdItems.CollectionId, null);
            var result = ASCNTCAdapter.Sync(request);
            ...
            var syncCollection = TestSuiteHelper.CreateSyncCollection(result.SyncKey, createdItems.CollectionId);
