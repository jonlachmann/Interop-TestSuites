...
public class S01_Sync : TestSuiteBase
{
    ...
    public void MSASCNTC_S01_TC01_Sync_AddContact()
    {
        ...
        var newAddedItem = GetSyncAddResult(contactProperties[Request.ItemsChoiceType8.FileAs].ToString(), User1Information.ContactsCollectionId, bodyPreference, null);
        ...
        VerifyContactClassElements(contactProperties, newAddedItem.Contact);
        #endregion
    }
    #endregion
    ...
    public void MSASCNTC_S01_TC02_Sync_GhostedElements_ExceptAssistantName()
    {
        ...
        // Get the new added contact
        var newAddedItem = GetSyncAddResult(contactProperties[Request.ItemsChoiceType8.FileAs].ToString(), User1Information.ContactsCollectionId, null, supportedElements);
        #endregion
        ...
        UpdateContact(SyncKey, User1Information.ContactsCollectionId, changeData);
        #endregion

        #region Call Sync command to synchronize the changed contact on the server
        // Get the updated contact
        var changedItem = GetSyncChangeResult(contactProperties[Request.ItemsChoiceType8.FileAs].ToString(), User1Information.ContactsCollectionId, SyncKey, null);
    ...
    public void MSASCNTC_S01_TC03_Sync_GhostedElement_AssistantName()
    {
        ...
        // Get the new added contact
        var newAddedItem = GetSyncAddResult(contactProperties[Request.ItemsChoiceType8.FileAs].ToString(), User1Information.ContactsCollectionId, bodyPreference, supportedElements);
        #endregion
        ...
        // Get the updated contact
        var changedItem = GetSyncChangeResult(contactProperties[Request.ItemsChoiceType8.FileAs].ToString(), User1Information.ContactsCollectionId, SyncKey, bodyPreference);
    ...
    {
        Site.Assume.AreNotEqual<string>("12.1", Common.GetConfigurationPropertyValue("ActiveSyncProtocolVersion", Site), "The recipient information cache is not supported with the value of the MS-ASProtocolVersion header is set to 12.1. MS-ASProtocolVersion header value is determined using Common PTFConfig property named ActiveSyncProtocolVersion.");

        #region Call SendMail command to send a mail to recipient
        var subject = Common.GenerateResourceName(Site, "Subject");
        var emailBody = Common.GenerateResourceName(Site, "Body");
        ...
        GetSyncAddResult(subject, User2Information.InboxCollectionId, null, null);
        #endregion
        ...
        var request = TestSuiteHelper.CreateSyncRequest(GetInitialSyncKey(User1Information.RecipientInformationCacheCollectionId, null), User1Information.RecipientInformationCacheCollectionId, null);

        var store = ASCNTCAdapter.Sync(request);
        ...
        #region Verify requirements
        foreach (var recipientInformationCacheItem in store.AddElements)
        {
            ...
            if (Common.IsRequirementEnabled(1010, Site))
            {
    ...
    public void MSASCNTC_S01_TC05_Sync_Status6_PictureExceeds48KB()
    {
        ...
        var picture = "BigPhoto.jpg";

        var contactProperties = SetContactProperties(picture);

        var syncAddStore = AddContact(User1Information.ContactsCollectionId, contactProperties);
        #endregion
    ...
    public void MSASCNTC_S01_TC06_Sync_AddContact_300CategoryElements()
    {
        ...
        var fileAs = Common.GenerateResourceName(Site, "Contact");
        ...
        var contactCategories = new Request.Categories1 { Category = new string[categories.Count] };
        ...
        RecordCaseRelativeItems(User1Information.UserName, User1Information.ContactsCollectionId, fileAs);
        #endregion

        #region Call Sync command to synchronize the contact added in previous step
        // Get the new added contact
        var newAddedItem = GetSyncAddResult(fileAs, User1Information.ContactsCollectionId, null, null);
        #endregion
