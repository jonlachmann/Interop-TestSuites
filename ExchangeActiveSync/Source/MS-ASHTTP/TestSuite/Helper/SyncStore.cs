...
public class SyncStore
{
    ...
    public SyncStore()
    {
        ...
        {
            addCommands = new Collection<SyncItem>();
        }
        ...
        {
            addResponses = new Collection<Response.SyncCollectionsCollectionResponsesAdd>();
        }
    }
