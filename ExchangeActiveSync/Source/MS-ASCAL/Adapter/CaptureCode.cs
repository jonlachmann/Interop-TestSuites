...
using SearchItem = Common.DataStructures.Search;
...
public partial class MS_ASCALAdapter
{
    ...
    private void VerifySyncCommandResponse(SyncStore syncResponse)
    {
        ...
        {
            for (var i = syncResponse.AddElements.Count - 1; i >= 0; i--)
            {
                if (null != syncResponse.AddElements[i].Calendar)
                {
                    var type = typeof(DataStructures.Calendar);
                    ...
                    if (null != syncResponse.AddElements[i].Calendar.AllDayEvent)
                    {
                        ...
                        VerifyUnsignedByteDataType(syncResponse.AddElements[i].Calendar.AllDayEvent);
                    }
                    ...
                    if (null != syncResponse.AddElements[i].Calendar.Attendees && null != syncResponse.AddElements[i].Calendar.Attendees.Attendee)
                    {
                        for (var j = syncResponse.AddElements[i].Calendar.Attendees.Attendee.Length - 1; j >= 0; j--)
                        {
                            ...
                            if (syncResponse.AddElements[i].Calendar.Attendees.Attendee[j].AttendeeTypeSpecified)
                            {
                                ...
                                var expectedValues = new string[] { "1", "2", "3" };
                                Common.VerifyActualValues("AttendeeType", expectedValues, syncResponse.AddElements[i].Calendar.Attendees.Attendee[j].AttendeeType.ToString(), Site);
                                ...
                                VerifyUnsignedByteDataType(syncResponse.AddElements[i].Calendar.Attendees.Attendee[j].AttendeeType);
                            ...
                            if (syncResponse.AddElements[i].Calendar.Attendees.Attendee[j].AttendeeStatusSpecified)
                            {
                                ...
                                var expectedValues = new string[] { "0", "2", "3", "4", "5" };
                                Common.VerifyActualValues("AttendeeStatus", expectedValues, syncResponse.AddElements[i].Calendar.Attendees.Attendee[j].AttendeeStatus.ToString(), Site);
                                ...
                                VerifyUnsignedByteDataType(syncResponse.AddElements[i].Calendar.Attendees.Attendee[j].AttendeeStatus);
                            }
                        }
                    ...
                    if (null != syncResponse.AddElements[i].Calendar.BusyStatus)
                    {
                        ...
                        var expectedValues = new string[] { "0", "1", "2", "3", "4" };
                        Common.VerifyActualValues("BusyStatus", expectedValues, syncResponse.AddElements[i].Calendar.BusyStatus.ToString(), Site);
                        ...
                        if (Common.GetConfigurationPropertyValue("ActiveSyncProtocolVersion", Site) == "14.0")
                        {
                            // Add the debug information
                        ...
                        VerifyUnsignedByteDataType(syncResponse.AddElements[i].Calendar.BusyStatus);
                    }
                    ...
                    if (!activeSyncProtocolVersion.Equals("12.1"))
                    {
                        if (null != syncResponse.AddElements[i].Calendar.Recurrence && syncResponse.AddElements[i].Calendar.Recurrence.CalendarTypeSpecified)
                        {
                            ...
                            VerifyUnsignedByteDataType(syncResponse.AddElements[i].Calendar.Recurrence.CalendarType);
                        }
                    }
                    ...
                    if (null != syncResponse.AddElements[i].Calendar.Recurrence && (syncResponse.AddElements[i].Calendar.Recurrence.Type == 2 || syncResponse.AddElements[i].Calendar.Recurrence.Type == 5))
                    {
                        if (syncResponse.AddElements[i].Calendar.Recurrence.DayOfMonthSpecified)
                        {
                            ...
                            VerifyUnsignedByteDataType(syncResponse.AddElements[i].Calendar.Recurrence.DayOfMonth);
                    ...
                    if (null != syncResponse.AddElements[i].Calendar.Recurrence && (syncResponse.AddElements[i].Calendar.Recurrence.Type == 0 || syncResponse.AddElements[i].Calendar.Recurrence.Type == 1 || syncResponse.AddElements[i].Calendar.Recurrence.Type == 3 || syncResponse.AddElements[i].Calendar.Recurrence.Type == 6))
                    {
                        if (syncResponse.AddElements[i].Calendar.Recurrence.DayOfWeekSpecified)
                        {
                            ...
                            var expectedValues = new string[] { "1", "2", "4", "8", "16", "32", "62", "64", "65", "127" };
                            Common.VerifyActualValues("DayOfWeek", expectedValues, syncResponse.AddElements[i].Calendar.Recurrence.DayOfWeek.ToString(), Site);
                    ...
                    if (!activeSyncProtocolVersion.Equals("12.1") && !activeSyncProtocolVersion.Equals("14.0"))
                    {
                        if (null != syncResponse.AddElements[i].Calendar.Recurrence && syncResponse.AddElements[i].Calendar.Recurrence.FirstDayOfWeekSpecified)
                        {
                            ...
                            var expectedValues = new string[] { "0", "1", "2", "3", "4", "5", "6" };
                            Common.VerifyActualValues("FirstDayOfWeek", expectedValues, syncResponse.AddElements[i].Calendar.Recurrence.FirstDayOfWeek.ToString(), Site);
                            ...
                            VerifyUnsignedByteDataType(syncResponse.AddElements[i].Calendar.Recurrence.FirstDayOfWeek);
                        }
                    }
                    ...
                    if (!activeSyncProtocolVersion.Equals("12.1"))
                    {
                        ...
                        if (null != syncResponse.AddElements[i].Calendar.Recurrence && syncResponse.AddElements[i].Calendar.Recurrence.IsLeapMonthSpecified)
                        {
                            ...
                            VerifyUnsignedByteDataType(syncResponse.AddElements[i].Calendar.Recurrence.IsLeapMonth);
                        }
                        ...
                        if (null != syncResponse.AddElements[i].Calendar.ResponseType)
                        {
                            ...
                            var expectedValues = new string[] { "0", "1", "2", "3", "4", "5" };
                            Common.VerifyActualValues("ResponseType", expectedValues, syncResponse.AddElements[i].Calendar.ResponseType.ToString(), Site);
                    ...
                    if (!activeSyncProtocolVersion.Equals("12.1") && !activeSyncProtocolVersion.Equals("14.0"))
                    {
                        if (null != syncResponse.AddElements[i].Calendar.MeetingStatus)
                        {
                            ...
                            var expectedValues = new string[] { "0", "1", "3", "5", "7", "9", "11", "13", "15" };
                            Common.VerifyActualValues("MeetingStatus", expectedValues, syncResponse.AddElements[i].Calendar.MeetingStatus.ToString(), Site);
                            ...
                            VerifyUnsignedByteDataType(syncResponse.AddElements[i].Calendar.MeetingStatus);
                        }
                    }
                    ...
                    if (null != syncResponse.AddElements[i].Calendar.Recurrence && syncResponse.AddElements[i].Calendar.Recurrence.MonthOfYearSpecified && (syncResponse.AddElements[i].Calendar.Recurrence.Type == 5 || syncResponse.AddElements[i].Calendar.Recurrence.Type == 6))
                    {
                        ...
                        VerifyUnsignedByteDataType(syncResponse.AddElements[i].Calendar.Recurrence.MonthOfYear);
                    }
                    ...
                    if (null != syncResponse.AddElements[i].Calendar.Sensitivity)
                    {
                        ...
                        var expectedValues = new string[] { "0", "1", "2", "3" };
                        Common.VerifyActualValues("Sensitivity", expectedValues, syncResponse.AddElements[i].Calendar.Sensitivity.ToString(), Site);
                        ...
                        VerifyUnsignedByteDataType(syncResponse.AddElements[i].Calendar.Sensitivity);
                    }
                    ...
                    if (null != syncResponse.AddElements[i].Calendar.Recurrence)
                    {
                        ...
                        var expectedValues = new string[] { "0", "1", "2", "3", "5", "6" };
                        Common.VerifyActualValues("Type", expectedValues, syncResponse.AddElements[i].Calendar.Recurrence.Type.ToString(), Site);
                        ...
                        VerifyUnsignedByteDataType(syncResponse.AddElements[i].Calendar.Recurrence.Type);
                        ...
                        if (syncResponse.AddElements[i].Calendar.Recurrence.Type == 3 || syncResponse.AddElements[i].Calendar.Recurrence.Type == 6)
                        {
                            ...
                            VerifyUnsignedByteDataType(syncResponse.AddElements[i].Calendar.Recurrence.WeekOfMonth);
                        }
                    }
                    ...
                    if (!activeSyncProtocolVersion.Equals("12.1"))
                    {
                        if (null != syncResponse.AddElements[i].Calendar.DisallowNewTimeProposal)
                        {
                            ...
                            VerifyBooleanDataType(syncResponse.AddElements[i].Calendar.DisallowNewTimeProposal);
                        }
                    }
                    ...
                    if (null != syncResponse.AddElements[i].Calendar.Exceptions)
                    {
                        if (null != syncResponse.AddElements[i].Calendar.Exceptions.Exception)
                        {
                            ...
                            foreach (var exception in syncResponse.AddElements[i].Calendar.Exceptions.Exception)
                            {
                                if (exception.DeletedSpecified)
                                {
                                    ...
                                    VerifyUnsignedByteDataType(exception.Deleted);
                                }
                    ...
                    if (null != syncResponse.AddElements[i].Calendar.Attendees)
                    {
                        ...
                        if (null != syncResponse.AddElements[i].Calendar.Attendees.Attendee)
                        {
                            ...
                            foreach (var attendee in syncResponse.AddElements[i].Calendar.Attendees.Attendee)
                            {
                                // Add the debug information
                                ...
                                Site.CaptureRequirementIfIsTrue(
                                    null != attendee.Email && activeSyncClient.ValidationResult,
                                    227,
                    ...
                    if (Common.GetConfigurationPropertyValue("ActiveSyncProtocolVersion", Site) == "16.0")
                    {
                    ...
                    if (Common.GetConfigurationPropertyValue("ActiveSyncProtocolVersion", Site) == "16.1")
                    {
                        if (syncResponse.AddElements[i].Calendar.Location1.DisplayName != null)
                        {
                            // Add the debug information
                    ...
                    if (null != syncResponse.AddElements[i].Calendar.OrganizerEmail)
                    {
                        ...
                        VerifyStringDataType();
                        VerifyEmailAddressDataType(syncResponse.AddElements[i].Calendar.OrganizerEmail);
                    }
                    ...
                    if (null != syncResponse.AddElements[i].Calendar.OrganizerName)
                    {
                        ...
                        if (activeSyncProtocolVersion.Equals("16.0"))
                        {
                            ...
                            Site.CaptureRequirementIfAreEqual<string>(
                                Common.GetConfigurationPropertyValue("OrganizerUserName", Site),
                    ...
                    if (!activeSyncProtocolVersion.Equals("12.1"))
                    {
                        if (null != syncResponse.AddElements[i].Calendar.ResponseRequested)
                        {
                            ...
                            VerifyBooleanDataType(syncResponse.AddElements[i].Calendar.ResponseRequested);
                        }
    ...
    private void VerifyItemOperationsResponse(ItemOperationsStore itemOperationResponse)
    {
        ...
        {
            for (var i = itemOperationResponse.Items.Count - 1; i >= 0; i--)
            {
                // Add the debug information
    ...
    private void VerifySearchCommandResponse(SearchStore searchResponse)
    {
        ...
        foreach (var itemInSearch in searchResponse.Results)
        {
            // Add the debug information
    ...
    private void VerifyWBXMLRequirements()
    {
        ...
        if (null != decodedData)
        {
            ...
            foreach (var decodeDataItem in decodedData)
            {
                ...
                var isValidCodePage = codePage >= 0 && codePage <= 24;
